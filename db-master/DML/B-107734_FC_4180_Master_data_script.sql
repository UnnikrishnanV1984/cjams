...
-- New Fiscal Category Code: 4180 - Title IV-B, Center for Excellence
-- for period October 1, 2020 or after September 30 2023.
...
values
	(	171, '4180', 'Title IV-B, Center for Excellence', '3952', 'A', 
		'4', 'B-107734', 'B-107734', 'N', '2020-10-01', '2023-09-30', 
		now(), now(), NULL, NULL, NULL, 50000.00 
	);
...
values
	(	gen_random_uuid(), '0c5e589f-78ce-42f9-8052-289d51e8dfdb', 'B-107734', now()::date, 'B-107734', 
		now(), 1, NULL, 171, NULL, NULL
	);
