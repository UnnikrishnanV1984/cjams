DROP FUNCTION IF EXISTS routingdaas(character varying, uuid, character varying, character varying, character varying, json, boolean);

CREATE OR REPLACE FUNCTION routingdaas(appeventcode character varying, intake_service_req_id uuid, fromuserid character varying, v_assignedsecurityid character varying, v_responsibilitytypekey character varying, j_assignfolder json DEFAULT '{}'::json, isnotifyuser boolean DEFAULT true)
