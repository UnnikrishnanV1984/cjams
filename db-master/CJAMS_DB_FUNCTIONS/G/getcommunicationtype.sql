DROP FUNCTION IF EXISTS  getcommunicationtype(v_teamtypekey character varying);
 CREATE OR REPLACE FUNCTION getcommunicationtype(v_teamtypekey character varying)                                                       
