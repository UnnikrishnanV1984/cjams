...
BEGIN
	RETURN QUERY
	select pi.provider_id as provider_id,pi.incident_date as incident_date,pi.incident_time as incident_time,pi.is_classthreeincident as classthreeincident,pi.uir_no as uir_no
