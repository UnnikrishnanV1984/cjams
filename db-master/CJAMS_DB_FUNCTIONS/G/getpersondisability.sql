DROP FUNCTION IF EXISTS getpersondisability(uuid);
DROP FUNCTION IF EXISTS getpersondisability(uuid,character varying);

----04/11/2023 MOUNIKA GUDISE added selectdisability column (CIDM-6925)


CREATE OR REPLACE FUNCTION cjams.getpersondisability(v_personid uuid,v_activeflag character varying )
