CREATE OR REPLACE FUNCTION cjams.get_auditlog(v_column character varying, v_tablename character varying, objectid character varying, pagenumber bigint, pagesize bigint)
 RETURNS json
 LANGUAGE plpgsql
AS $function$  
------------------------------------------------------------------------------------------------------------
