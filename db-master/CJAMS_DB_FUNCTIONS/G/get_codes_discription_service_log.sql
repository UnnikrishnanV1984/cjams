-- FUNCTION: cjams.get_codes_discription_service_log(text, integer)

-- DROP FUNCTION cjams.get_codes_discription_service_log(text, integer);

CREATE OR REPLACE FUNCTION cjams.get_codes_discription_service_log(casenumber text, v_client_id integer)
...
INNER JOIN tb_service_log   	AS TSL ON TSL.agency_program_area_id = APA.programkey
 ...
 WHERE TSL.provider_service_id IS NULL AND TSL.case_id = caseNumber ::bigint and TSL.delete_sw ='N' and TSL.client_id = v_client_id
