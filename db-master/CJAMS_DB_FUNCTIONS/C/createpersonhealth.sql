 CREATE OR REPLACE FUNCTION public.createpersonhealth(personjson json, v_personid uuid, securityuserid character varying)                                                           
  RETURNS text                                                                                                                                                                      
  LANGUAGE plpgsql                                                                                                                                                                  
 AS $function$                                                                                                                                                                    
 ...
 BEGIN                                                                                                                                                                            
  ...
  CREATE TEMP TABLE temp_sp_Create_Temp_personhealthexaminationss  (                                                                                                              
  ...
  CREATE TEMP TABLE temp_sp_Create_Temp_personmedicalconditionss  (                                                                                                               
 ...
 CREATE TEMP TABLE temp_sp_Create_Temp_personbehavioralhealthss  (                                                                                                                
 ...
 CREATE TEMP TABLE temp_sp_Create_Temp_personabusehistoryss  (                                                                                                                    
 ...
 CREATE TEMP TABLE temp_sp_Create_Temp_personabusesubstancess  (                                                                                                                  
 ...
 CREATE TEMP TABLE temp_sp_Create_Temp_PhysicianInfoss  (                                                                                                                         
 ...
 CREATE TEMP TABLE temp_sp_Create_Temp_PersonHealthInsurancess (                                                                                                                  
 ...
 CREATE TEMP TABLE temp_sp_Create_Temp_personmedicpshychotropicss  (                                                                                                              
 ...
 CREATE TEMP TABLE temp_sp_Create_Temp_PersonDentalinfoss  (                                                                                                                      
    ...
    insert into temp_sp_Create_Temp_personhealthexaminationss                                                                                                                     
         ...
         insert into temp_sp_Create_Temp_personmedicalconditionss                                                                                                                 
         ...
         insert into temp_sp_Create_Temp_personbehavioralhealthss                                                                                                                 
         ...
         insert into temp_sp_Create_Temp_personabusehistoryss                                                                                                                     
          select * from json_to_recordset(s_personabusehistoryObj ) as x(                                                                                                         
                 ...
                 */                                                                                                                                                               
                 ...
                 raise notice 's_personabusehistoryObj--%>',s_personabusehistoryObj;                                                                                              
                 insert into temp_sp_Create_Temp_personabusehistoryss  (                                                                                                          
 ...
 /*                                                                                                                                                                               
         ...
         */                                                                                                                                                                       
         ...
         s_physicianInfoObj:= i->>'physicianinfo';                                                                                                                                
          insert into temp_sp_Create_Temp_PhysicianInfoss                                                                                                                         
         ...
         s_healthInsuranceObj:= i->>'healthinsurance';                                                                                                                            
           insert into temp_sp_Create_Temp_PersonHealthInsurancess                                                                                                                
         ...
         s_medicationPhyscotropicObj:= i->>'personmedicationphyscotropic';                                                                                                        
            insert into temp_sp_Create_Temp_personmedicpshychotropicss                                                                                                            
 ...
 s_DentalinfoObj:= i->>'persondentalinfo';                                                                                                                                        
  ...
  insert into temp_sp_Create_Temp_PersonDentalinfoss                                                                                                                              
         ...
         update temp_sp_Create_Temp_personhealthexaminationss set  isNew =1 where coalesce(personhealthexaminationid,'') ='';                                                     
                                                                                                                                                                                  
         UPDATE personhealthexamination SET activeflag=0, updatedby = v_securityuserid, updatedon = v_date                                                                        
         WHERE personhealthexaminationid  in (select personhealthexaminationid::uuid from temp_sp_Create_Temp_personhealthexaminationss where isnew=0);                           
                   ...
                   SELECT p_Personid::uuid,healthexamname, practitionername, outcomeresults, healthdomaintypekey,healthassessmenttypekey, healthprofessiontypekey,assessmentdate, 
                                         notes,1,v_securityuserid,v_securityuserid, v_date, v_date FROM   temp_sp_Create_Temp_personhealthexaminationss WHERE isNew=1;            
                                                                                                                                                                                  
                                                                                                                                                                                  
                                                                                                                                                                                  
 update temp_sp_Create_Temp_personmedicalconditionss  set  isNew =1 where coalesce(personmedicalconditionid,'') ='';                                                              
 ...
 WHERE personmedicalconditionid  in (select personmedicalconditionid::uuid from                                                                                                   
                                                                         temp_sp_Create_Temp_personmedicalconditionss where isnew=0);                                             
                    ...
                    SELECT p_Personid::uuid,begindate, enddate, recordedby, medicalconditionother,                                                                                
                         1,v_securityuserid,v_securityuserid, v_date, v_date FROM   temp_sp_Create_Temp_personmedicalconditionss WHERE isNew=1;                                   
            -- RETURNING "personmedicalconditionid" into v_personmedicalconditionid;                                                                                              
            select personmedicalconditionid into v_personmedicalconditionid from personmedicalcondition                                                                           
         where activeflag=1 order by v_personmedicalconditionid desc limit 1;                                                                                                     
 ...
 END LOOP;                                                                                                                                                                        
         ...
         update temp_sp_Create_Temp_personbehavioralhealthss set  isNew =1 where coalesce(personbehavioralhealthid,'') ='';                                                       
                                                                                                                                                                                  
         UPDATE personbehavioralhealth SET activeflag=0, updatedby = v_securityuserid, updatedon = v_date                                                                         
         WHERE personbehavioralhealthid  in (select personbehavioralhealthid::uuid from temp_sp_Create_Temp_personbehavioralhealthss where isnew=0);                              
                       ...
                       1,v_securityuserid,v_securityuserid, v_date, v_date FROM                                                                                                   
                                   temp_sp_Create_Temp_personbehavioralhealthss WHERE isNew=1;                                                                                    
                                                                                                                                                                                  
                                                                                                                                                                                  
         update temp_sp_Create_Temp_personabusehistoryss set  isNew =1 where coalesce(personabusehistoryid,'') ='';                                                               
                                                                                                                                                                                  
         UPDATE personabusehistory SET activeflag=0, updatedby = v_securityuserid, updatedon = v_date                                                                             
         WHERE personabusehistoryid  in (select personabusehistoryid::uuid from temp_sp_Create_Temp_personabusehistoryss where isnew=0);                                          
                         ...
                         insert into personabusehistory(personid,isneglect,isemotionalabuse,isphysicalabuse,issexualabuse,                                                        
                                         ...
                                         isphysicalabuse::bool,issexualabuse::bool,                                                                                               
                                                  neglectnotes,physicalnotes,emotionalnotes,sexualnotes,                                                                          
                       1,v_securityuserid,v_securityuserid, v_date, v_date FROM                                                                                                   
                                   temp_sp_Create_Temp_personabusehistoryss WHERE isNew=1;                                                                                        
                                                                                                                                                                                  
                                                                                                                                                                                  
                                                                                                                                                                                  
         update temp_sp_Create_Temp_personabusesubstancess set  isNew =1 where coalesce(personabusesubstanceid,'') ='';                                                           
                                                                                                                                                                                  
         UPDATE personabusesubstance SET activeflag=0, updatedby = v_securityuserid, updatedon = v_date where personid= p_Personid;                                               
         --WHERE personabusesubstanceid  in (select personabusesubstanceid::uuid from                                                                                             
                                 ...
                                 insert into personabusesubstance(personid,isusetobacco,isusedrugoralcohol,isusedrug,isusealcohol,                                                
                                                  drugfrequencydetails, drugageatfirstuse, alcoholfrequencydetails, alcoholageatfirstuse,                                         
                                                  drugoralcoholproblems,                                                                                                          
                                         activeflag, updatedby,insertedby, updatedon, insertedon,tobaccoageatfirstuse,tobaccofrequencydetails    )                                
                                                                                                                                                                                  
                                         SELECT p_Personid::uuid, isusetobacco,isusedrugoralcohol,isusedrug,isusealcohol,                                                         
                                                   drugfrequencydetails, drugageatfirstuse,alcoholfrequencydetails, alcoholageatfirstuse,                                         
                                                  drugoralcoholproblems,                                                                                                          
                       1,v_securityuserid,v_securityuserid, v_date, v_date,tobaccoageatfirstuse,tobaccofrequencydetails FROM                                                      
                                   temp_sp_Create_Temp_personabusesubstancess WHERE isNew=1;                                                                                      
                                                                                                                                                                                  
                                                                                                                                                                                  
                                                                                                                                                                                  
                                                                                                                                                                                  
                                                                                                                                                                                  
         update temp_sp_Create_Temp_PhysicianInfoss set  isNew =1 where coalesce(personphycisianinfoid,'') ='';                                                                   
                                                                                                                                                                                  
         UPDATE personphycisianinfo SET activeflag=0, updatedby = v_securityuserid, updatedon = v_date                                                                            
         WHERE personphycisianinfoid  in (select personphycisianinfoid::uuid from temp_sp_Create_Temp_PhysicianInfoss where isnew=0);                                             
                 ...
                 INSERT INTO personphycisianinfo( personid, isprimaryphycisian, name,                                                                                             
                                 ...
                                 SELECT p_Personid::uuid, isprimaryphycisian, name,                                                                                               
                                  ...
                                  startdate, enddate,physicianspecialtytypekey,                                                                                                   
                       1,v_securityuserid,v_securityuserid, v_date, v_date FROM                                                                                                   
                                   temp_sp_Create_Temp_PhysicianInfoss WHERE isNew=1;                                                                                             
                                                                                                                                                                                  
                                                                                                                                                                                  
                                                                                                                                                                                  
         update temp_sp_Create_Temp_PersonHealthInsurancess set  isNew =1 where coalesce(personhealthinsuranceid,'') ='';                                                         
                                                                                                                                                                                  
         UPDATE personhealthinsurance SET activeflag=0, updatedby = v_securityuserid, updatedon = v_date                                                                          
         WHERE personhealthinsuranceid  in (select personhealthinsuranceid::uuid from temp_sp_Create_Temp_PersonHealthInsurancess where isnew=0);                                 
                                                                                                                                                                                  
              INSERT INTO personhealthinsurance( personid, ismedicaidmedicare, providertype, policyholdername,                                                                    
                                 address1, address2, city, state, countyid, zip,                                                                                                  
                                 providerphone, patientpolicyholderrelation, policyname, groupnumber,providertypeother, insurancetype,medicarenumber,isinsuranceavailable,        
                                 activeflag, insertedby, updatedby, insertedon, updatedon)                                                                                        
                         ...
                         SELECT p_Personid::uuid, ismedicaidmedicare::bool, providertype, policyholdername,                                                                       
                                 ...
                                 providerphone, patientpolicyholderrelation, policyname, groupnumber,providertypeother,insurancetype,medicarenumber,isinsuranceavailable,         
                                 1, v_securityuserid,v_securityuserid, v_date, v_date                                                                                             
                         FROM   temp_sp_Create_Temp_PersonHealthInsurancess WHERE isnew=1;                                                                                        
                                                                                                                                                                                  
                                                                                                                                                                                  
                                                                                                                                                                                  
         update temp_sp_Create_Temp_personmedicpshychotropicss set  isNew =1 where coalesce(personmedicpshychotropicid,'') ='';                                                   
         ...
         WHERE personmedicpshychotropicid  in (select personmedicpshychotropicid::uuid from                                                                                       
                                                                                   temp_sp_Create_Temp_personmedicpshychotropicss where isnew=0);                                 
         ...
         INSERT INTO personmedicpshychotropic( personid, medicationname, medicationeffectivedate,                                                                                 
                                                 ...
                                                 startdate,enddate,compliant,reportedby,medicationtypekey,monitoring,                                                             
                                                 activeflag, insertedby, updatedby, insertedon, updatedon)                                                                        
                         ...
                         SELECT p_Personid::uuid, medicationname, medicationeffectivedate,                                                                                        
                                                  ...
                                                  startdate,enddate,compliant,reportedby,medicationtypekey,monitoring,                                                            
                                                 1, v_securityuserid,v_securityuserid, v_date, v_date                                                                             
                         FROM   temp_sp_Create_Temp_personmedicpshychotropicss WHERE isNew=1;                                                                                     
                                                                                                                                                                                  
 update temp_sp_Create_Temp_PersonDentalinfoss set  isNew =1 where coalesce(persondentalinfoid,'') ='';                                                                           
                                                                                                                                                                                  
         UPDATE persondentalinfo SET activeflag=0, updatedby = v_securityuserid, updatedon = v_date                                                                               
         WHERE persondentalinfoid  in (select persondentalinfoid::uuid from temp_sp_Create_Temp_PersonDentalinfoss where isnew=0);                                                
                         ...
                         activeflag, insertedby, updatedby, insertedon, updatedon)                                                                                                
                                 ...
                                 SELECT p_Personid::uuid, isdentalinfo, dentistname,                                                                                              
                                  ...
                                  address1, address2, city, state, countyid::uuid, zip,                                                                                           
                       1,v_securityuserid,v_securityuserid, v_date, v_date FROM                                                                                                   
                                   temp_sp_Create_Temp_PersonDentalinfoss WHERE isNew=1;                                                                                          
 ...
 DROP TABLE temp_sp_Create_Temp_personhealthexaminationss;                                                                                                                        
 DROP TABLE temp_sp_Create_Temp_personmedicalconditionss;                                                                                                                         
 DROP TABLE temp_sp_Create_Temp_personbehavioralhealthss;                                                                                                                         
 DROP TABLE temp_sp_Create_Temp_personabusehistoryss;                                                                                                                             
 DROP TABLE temp_sp_Create_Temp_personabusesubstancess;                                                                                                                           
 DROP TABLE temp_sp_Create_Temp_PhysicianInfoss;                                                                                                                                  
 DROP TABLE temp_sp_Create_Temp_PersonHealthInsurancess;                                                                                                                          
 DROP TABLE temp_sp_Create_Temp_personmedicpshychotropicss;                                                                                                                       
 DROP TABLE temp_sp_Create_Temp_PersonDentalinfoss;                                                                                                                               
