CREATE OR REPLACE FUNCTION cjams.managevendorapplicant(searchobj json)
...
update tb_provider_addresses set delete_sw='Y' where parent_key_id=v_providerid;
