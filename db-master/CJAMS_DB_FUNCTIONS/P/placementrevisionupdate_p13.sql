drop FUNCTION if exists cjams.placementrevisionupdate(	v_placementid character varying, 
...
CREATE OR REPLACE FUNCTION cjams.placementrevisionupdate(	v_placementid character varying, 
															v_startdate timestamp without time zone, 
															v_starttime character varying, 
															v_voidreasontypekey character varying, 
															v_voidremarks character varying, 
															...
															securityuserid character varying, 
															v_voiddate timestamp without time zone,
                                                            v_leastrestrictiveplacement character varying DEFAULT NULL::character varying
														)
 RETURNS text
 LANGUAGE plpgsql
AS $function$
