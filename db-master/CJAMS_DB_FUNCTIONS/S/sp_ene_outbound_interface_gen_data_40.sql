CREATE OR REPLACE FUNCTION cjams.sp_ene_outbound_interface_gen_data_40(	vl_client_id integer, 
																		vl_other_id bigint, 
...
-- Description: To generate E&E Inbound data for Record Type 40
...
DECLARE VS_RECORD_TYPE VARCHAR(2);
	...
	ENE_OUT_OTHER_COL1 CHAR(5);
	ENE_OUT_OTHER_COL2 DECIMAL(10,2);
	ENE_OUT_OTHER_COL2_CONV VARCHAR(15);
	ENE_OUT_OTHER_COL3 DECIMAL(10,2);
	ENE_OUT_OTHER_COL3_CONV VARCHAR(15);
...
BEGIN    
    ...
    IF VS_RECORD_TYPE = '40' THEN
		...
		FETCH CURSOR_OTHER INTO ENE_OUT_OTHER_COL1, ENE_OUT_OTHER_COL2, ENE_OUT_OTHER_COL3 ;
			...
			ENE_OUT_OTHER_COL2_CONV = LTRIM(RTRIM(ENE_OUT_OTHER_COL2::VARCHAR)) ;
			ENE_OUT_OTHER_COL2_CONV = SUBSTRING('00000000000',1,11 - LENGTH(ENE_OUT_OTHER_COL2_CONV)) || ENE_OUT_OTHER_COL2_CONV ;

			ENE_OUT_OTHER_COL3_CONV = LTRIM(RTRIM(ENE_OUT_OTHER_COL3::VARCHAR));
			ENE_OUT_OTHER_COL3_CONV = SUBSTRING('00000000000',1,11 - LENGTH(ENE_OUT_OTHER_COL3_CONV)) || ENE_OUT_OTHER_COL3_CONV ;	
			...
			SELECT
				...
				END),
				ENE_OUT_OTHER_COL1,
				(CASE WHEN ENE_OUT_OTHER_COL2_CONV = '' THEN '00000000.00'
					WHEN LENGTH(ENE_OUT_OTHER_COL2_CONV) <= 0 THEN '00000000.00'
					ELSE COALESCE(ENE_OUT_OTHER_COL2_CONV::VARCHAR,'00000000.00')
				END),  		
				(CASE WHEN ENE_OUT_OTHER_COL3_CONV = '' THEN '00000000.00'
					WHEN LENGTH(ENE_OUT_OTHER_COL3_CONV) <= 0 THEN '00000000.00'
					ELSE COALESCE(ENE_OUT_OTHER_COL3_CONV::VARCHAR,'00000000.00')
				END)		
			;	
