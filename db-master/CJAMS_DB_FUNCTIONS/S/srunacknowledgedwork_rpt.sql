 CREATE OR REPLACE FUNCTION public.srunacknowledgedwork_rpt(_page integer, _limit integer)                                                                                                          
  RETURNS TABLE(danumber character varying, datype character varying, dasubtype character varying, reporteddate timestamp with time zone, team character varying, overdue integer, region integer)  
  LANGUAGE plpgsql                                                                                                                                                                                  
 AS $function$                                                                                                                                                                                      
 DECLARE                                                                                                                                                                                            
 v_liPageNumber  INT;                                                                                                                                                                               
 ...
 FROM IntakeServiceRequest ISR                                                                                                                                                                      
  ...
  LIMIT _limit OFFSET v_pageoffset;                                                                                                                                                                 
