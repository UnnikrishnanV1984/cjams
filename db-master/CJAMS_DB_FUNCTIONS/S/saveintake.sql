 CREATE OR REPLACE FUNCTION public.saveintake(intakejson jsonb)                                                 
  RETURNS text                                                                                                  
  LANGUAGE plpgsql                                                                                              
 AS $function$                                                                                                  
 ...
 SELECT MAX(versionnumber) into l_versionNumber FROM intakedastaging as i where i.intakenumber = l_IntakeNumber;
 UPDATE intakedastaging set activeflag = 0 where intakenumber = l_IntakeNumber;                                 
                                                                                                                
 INSERT INTO intakedastaging(                                                                                   
             intakenumber, dateRecieved, narrative, raname, entityname,                                         
             cruworkername, data, insertedon, insertedby, timerecieved, updatedon,                              
             updatedby, status,jsondata,versionnumber,teamtypekey)                                                          
     VALUES (l_IntakeNumber,  l_DateRecieved, l_Narrative, l_RAName, null,                                      
             v_securityuserid, null, now(), v_securityuserid, now(), null,                                      
             null, 'pending',intakejson,l_versionNumber+1,'CW');                                                     
