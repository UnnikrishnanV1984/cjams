CREATE OR REPLACE FUNCTION cjams.sp_ene_interface_load_inbound( 	vs_batch_user character varying, 
...
-- Load Inbund data from E&E Interface
...
BEGIN          
    ...
    IF VS_RECORD_TYPE NOT IN ('02','16','21','46','51') THEN
		...
		VS_ERROR_CODE := '506';
		VS_ERROR_DESC := 'Invalid Record Type: ' || VS_RECORD_TYPE;
		VS_MESSAGE := '(E&E) THE RUN WAS UNSUCCESSFUL.';
		
		INSERT INTO interfaceserrorlog
			( interfaceid, currentruntimestamp, batchnumber, errorlineno, errorcode, errorsqlcode, errordescription ) 
		VALUES
			('ENE_INBOUND', current_timestamp, VS_BATCH_NO, 0, VS_ERROR_CODE, VS_CIS_CLIENT_ID, VS_ERROR_DESC) ;
	...
	IF NOT EXISTS (SELECT 1 FROM person WHERE cisclientid = VS_CIS_CLIENT_ID::VARCHAR AND activeflag = 1) THEN -- #13722
		...
		VS_ERROR_CODE := '000';
		VS_ERROR_DESC = '(E&E) CIS Client ID is unknown to CJAMS - NO UPDATES APPLIED';
		VS_MESSAGE := ' ';          
	...
	IF VS_CIS_CLIENT_ID IS NULL OR VS_CIS_CLIENT_ID = '' THEN
		...
		VS_ERROR_CODE := '503';
		VS_ERROR_DESC := '(E&E) Missing Mandatory Field CIS Client ID';
    ...
    IF VS_RECORD_TYPE = '02' THEN          
        ...
        IF LENGTH(VS_VALUE5) > 0 THEN
			...
			BEGIN            
				...
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For SSN.';
		...
		IF LENGTH(VS_VALUE6) > 0 THEN
            ...
            BEGIN                        
				...
				VL_OUTPUT_SQLCODE := '504';				
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For DOB.';
		...
		IF EXISTS(SELECT 1 from caresclient WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
            ...
            BEGIN       
				...
				VL_OUTPUT_SQLCODE := '504';				
				VS_ERROR_CODE := '504';
				VS_MESSAGE := '(E&E) UPDATE OF caresclient FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' - ' || SQLERRM;
				VS_ERROR_DESC := '(E&E) UPDATE OF caresclient FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' - ' || SQLERRM;
        ...
        ELSE
			BEGIN          
				...
				VL_OUTPUT_SQLCODE := '504';
				VS_ERROR_CODE  := '504';
				VS_MESSAGE := '(E&E) INSERT INTO caresclient FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' - ' || SQLERRM;
				VS_ERROR_DESC := '(E&E) INSERT INTO caresclient FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' - ' || SQLERRM ;
	...
	IF VS_RECORD_TYPE = '16' THEN
		...
		IF VS_VALUE1 IS NULL OR VS_VALUE1 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field AU Number.';
		...
		IF VS_VALUE2 IS NULL OR VS_VALUE2 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field MA Type.';
		...
		BEGIN  
			...
			VL_OUTPUT_SQLCODE := '504';
			VS_ERROR_CODE := '504';
			VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For AU Number.';
		...
		IF LENGTH(VS_VALUE3) > 0 THEN
            ...
            BEGIN       
				...
				VL_OUTPUT_SQLCODE := '504';				
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For MA Elig Start Date.';
		...
		IF LENGTH(VS_VALUE4) > 0 THEN
            ...
            BEGIN  
				...
				VL_OUTPUT_SQLCODE := '504';				
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For MA Elig End Date.';
		...
		IF EXISTS(SELECT 1 from caresclientma   WHERE SUBSTRING('000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
			...
			BEGIN                     
				...
				VL_OUTPUT_SQLCODE := '504';
				VS_ERROR_CODE := '504';
				VS_MESSAGE := '(E&E) UPDATE1 OF caresclientma FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') ||' AND auno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM  ;
				VS_ERROR_DESC := '(E&E) UPDATE1 OF caresclientma FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') ||' AND auno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
        ...
        ELSE
            BEGIN                
				...
				VL_OUTPUT_SQLCODE := '504';
				VS_ERROR_CODE := '504';
				VS_MESSAGE := '(E&E) INSERT INTO caresclientma FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND auno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
				VS_ERROR_DESC := '(E&E) INSERT INTO caresclientma FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND auno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
	...
	IF VS_RECORD_TYPE = '21' THEN
		...
		IF VS_VALUE8 = 'Y' THEN -- Vineet 04/07/2020 old value as '0'
			IF VS_VALUE1 IS NULL OR VS_VALUE1 = '' THEN
				VL_OUTPUT_SQLCODE := '00000';
				VS_ERROR_CODE := '000';
				VS_ERROR_DESC := 'NO UPDATES APPLIED';
				VS_MESSAGE := 'NO UPDATES APPLIED';          
				RETURN ;
			ELSE
				IF EXISTS(SELECT 1 from caresclientassets WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
					...
					BEGIN                       
						...
						VL_OUTPUT_SQLCODE := '504';
						VS_ERROR_CODE := '504';
						VS_MESSAGE := '(E&E) UPDATE OF assetsdeleteflag IN caresclientassets FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') ||' AND assetidno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
						VS_ERROR_DESC := '(E&E) UPDATE OF assetsdeleteflag IN caresclientassets FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') ||' AND assetidno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
					...
					VL_OUTPUT_SQLCODE := '00000';
					VS_ERROR_CODE := '000';
					VS_ERROR_DESC := '(E&E) assetsdeleteflag SET IN caresclientassets FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') ||' AND assetidno: ' || coalesce(VS_VALUE1,'') ;
					VS_MESSAGE := '(E&E) assetsdeleteflag SET IN caresclientassets FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') ||' AND assetidno: ' || coalesce(VS_VALUE1,'') ;
		...
		IF VS_VALUE1 IS NULL OR VS_VALUE1 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Asset ID No.';
		...
		IF VS_VALUE2 IS NULL OR VS_VALUE2 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Asset Type.';
		...
		IF VS_VALUE9 IS NULL OR VS_VALUE9 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE  := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Asset Date.';
        ...
        BEGIN                
			...
			VL_OUTPUT_SQLCODE := '504';	
			VS_ERROR_CODE := '504';
			VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Asset ID No.';
        ...
        IF LENGTH(VS_VALUE3) > 0 THEN                     
			...
			BEGIN                        
				...
				VL_OUTPUT_SQLCODE := '504';	
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Asset Owner.';
        ...
        IF LENGTH(VS_VALUE4) > 0 THEN
			...
			BEGIN                        
				...
				VL_OUTPUT_SQLCODE := '504';				
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Asset Amount.';
		...
		IF LENGTH(VS_VALUE9) > 0 THEN          
			...
			BEGIN      
				...
				VL_OUTPUT_SQLCODE := '504';			
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Asset Date.';
        ...
        IF EXISTS(SELECT 1 from caresclientassets WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
			...
			IF EXISTS(SELECT 1 from caresclientassets WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
				= SUBSTRING('0000000000',1,10 - LENGTH(VS_CIS_CLIENT_ID::varchar):: integer) || (VS_CIS_CLIENT_ID) AND assetidno = VS_VALUE1::INTEGER AND activeflag = 0) THEN                                        
					VL_OUTPUT_SQLCODE := '504';
					VS_ERROR_CODE := '504';
					VS_MESSAGE := '(E&E) DELETED RECORD EXISTS IN caresclientassets FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND assetidno: ' || coalesce(VS_VALUE1,'');
					VS_ERROR_DESC := '(E&E) DELETED RECORD EXISTS IN caresclientassets FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND assetidno: ' || coalesce(VS_VALUE1,'');
				...
				BEGIN
					UPDATE caresclientassets
						SET assetowner = (CASE WHEN VS_VALUE3 IS NULL THEN NULL
							...
							assetsdeleteflag = (CASE WHEN VS_VALUE8 = 'Y' THEN 0 ELSE 1 END)::integer,
							updatedby = VS_BATCH_USER,
							updatedon = CURRENT_TIMESTAMP,
					...
					VL_OUTPUT_SQLCODE := '504';
					VS_ERROR_CODE := '504';
					VS_MESSAGE := '(E&E) UPDATE OF caresclientassets FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND assetidno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
					VS_ERROR_DESC := '(E&E) UPDATE OF caresclientassets FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND assetidno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
        ...
        ELSE
			...
			BEGIN              
				...
				SELECT
					...
					VS_VALUE6,                    
					VS_VALUE7,          
					(CASE WHEN VS_VALUE8 = 'Y' THEN 0 ELSE 1 END)::integer,
					VS_BATCH_USER,
					CURRENT_TIMESTAMP,
					VS_BATCH_USER,
					CURRENT_TIMESTAMP,
				...
				VL_OUTPUT_SQLCODE := '504';
				VS_ERROR_CODE := '504';
				VS_MESSAGE := '(E&E) INSERT INTO caresclientassets FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND assetidno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ; 
				VS_ERROR_DESC := '(E&E) INSERT INTO caresclientassets FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND assetidno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
	...
	IF VS_RECORD_TYPE = '51' THEN
		...
		IF VS_VALUE9 = 'Y' THEN
			IF VS_VALUE1 IS NULL OR VS_VALUE1 = '' THEN
				VL_OUTPUT_SQLCODE := '00000';
				VS_ERROR_CODE := '000';
				VS_ERROR_DESC := 'NO UPDATES APPLIED1';
				VS_MESSAGE := 'NO UPDATES APPLIED1';          
				RETURN   ;
            ELSE
				IF EXISTS(SELECT 1 FROM caresclientincome WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
					...
					BEGIN    
						...
						VL_OUTPUT_SQLCODE := '504';
						VS_ERROR_CODE := '504';
						VS_MESSAGE := '(E&E) UPDATE OF incomedeleteflag IN caresclientincome FAILED FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID ||' AND old_id:'||VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM ;
						VS_ERROR_DESC := '(E&E) UPDATE OF incomedeleteflag IN caresclientincome FAILED FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID ||' AND old_id:'||VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM ; 
					...
					VL_OUTPUT_SQLCODE := '00000';
					VS_ERROR_CODE := '000';
					VS_ERROR_DESC := '(E&E) incomedeleteflag SET IN caresclientincome FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id:'||VS_VALUE1 || ' AND incometype: ' || VS_VALUE2;
					VS_MESSAGE := '(E&E) incomedeleteflagSET IN caresclientincome FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id:'||VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM ;
				...
				ELSE
					VL_OUTPUT_SQLCODE := '00000';
					VS_ERROR_CODE := '000';
					VS_ERROR_DESC := 'NO UPDATES APPLIED2';
					VS_MESSAGE := 'NO UPDATES APPLIED2' ;      
		...
		IF VS_VALUE1 IS NULL OR VS_VALUE1 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field old_id (CIS Client ID).';
		...
		IF VS_VALUE2 IS NULL OR VS_VALUE2 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Income Type.';
		...
		IF VS_VALUE3 IS NULL OR VS_VALUE3 = '' THEN
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Income Category.';
		...
		IF VS_VALUE4 IS NULL OR VS_VALUE4 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Income Amount.';
		...
		IF VS_VALUE5 IS NULL OR VS_VALUE5 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Income Verification.';
		...
		IF VS_VALUE8 IS NULL OR VS_VALUE8 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Income Frequency.';
		...
		BEGIN  
			...
			VL_OUTPUT_SQLCODE := '504';			
			VS_ERROR_CODE := '504';
			VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For old_id (CIS Client ID).';
		...
		IF LENGTH(VS_VALUE4) > 0 THEN
			...
			BEGIN                         
				...
				VL_OUTPUT_SQLCODE := '504';	
				VS_ERROR_CODE  := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Income Amount.';
		...
		IF LENGTH(VS_VALUE6) > 0 THEN
			...
			BEGIN    
				...
				VL_OUTPUT_SQLCODE := '504';	
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Income Start Date.';
		...
		IF LENGTH(VS_VALUE7) > 0 THEN
			...
			BEGIN    
				...
				VL_OUTPUT_SQLCODE := '504';	
				VS_ERROR_CODE := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Income End Date.';
		...
		IF EXISTS(SELECT 1 FROM caresclientincome WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
			...
			IF EXISTS(SELECT 1 FROM caresclientincome WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
				= SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(VS_CIS_CLIENT_ID)))) || LTRIM(RTRIM(VS_CIS_CLIENT_ID)) AND old_id  :: integer  = VS_VALUE1::INTEGER AND incometype = VS_VALUE2 AND activeflag =0) THEN
					VL_OUTPUT_SQLCODE := '504';
					VS_ERROR_CODE := '504';
					VS_MESSAGE := '(E&E) DELETED RECORD EXISTS IN caresclientincome FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id: ' || VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM  ;
					VS_ERROR_DESC := '(E&E) DELETED RECORD EXISTS IN caresclientincome FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id: ' || VS_VALUE1 || ' AND incometype: ' || VS_VALUE2;
			...
			IF EXISTS(SELECT 1 FROM caresclientincome WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
				...
				BEGIN
					UPDATE caresclientincome
						...
						incomedeleteflag = (CASE WHEN VS_VALUE9 = 'Y' THEN 0 ELSE 1 END)::integer,
						updatedby = VS_BATCH_USER,
						updatedon = CURRENT_TIMESTAMP,
						statusflag = 'N',
						activeflag = 1
					...
					VL_OUTPUT_SQLCODE := '504';
					VS_ERROR_CODE := '504';
					VS_MESSAGE := '(E&E) UPDATE OF caresclientincome FAILED FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id: ' || VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM ;
					VS_ERROR_DESC := '(E&E) UPDATE OF caresclientincome FAILED FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id: ' || VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM ;
        ...
        ELSE
			BEGIN          
				...
				SELECT
					...
					END),
					VS_VALUE8,          
					(CASE WHEN VS_VALUE9 = 'Y' THEN 0 ELSE 1 END)::integer,
					VS_BATCH_USER,
					CURRENT_TIMESTAMP,
					VS_BATCH_USER,
					CURRENT_TIMESTAMP,
				...
				VL_OUTPUT_SQLCODE := '504';
				VS_ERROR_CODE  := '504';
				VS_MESSAGE := '(E&E) INSERT INTO caresclientincome FAILED FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id: ' || VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM   ;
				VS_ERROR_DESC := '(E&E) INSERT INTO caresclientincome FAILED FOR old_id-cisclientid: ' || VS_CIS_CLIENT_ID || ' AND old_id: ' || VS_VALUE1 || ' AND incometype: ' || VS_VALUE2 || ' - ' || SQLERRM  ;
	...
	IF VS_RECORD_TYPE = '46' THEN
		...
		IF VS_VALUE5 = 'Y' THEN
			...
			ELSE
				IF EXISTS(SELECT 1 from caresclientemployer WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
					...
					VL_OUTPUT_SQLCODE := '00000';
					VS_ERROR_CODE := '000';
					VS_ERROR_DESC := '(E&E) employerdeleteflag SET IN caresclientemployer FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'');
					VS_MESSAGE := '(E&E) employerdeleteflag SET IN caresclientemployer FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'');
        ...
        IF VS_VALUE1 IS NULL OR VS_VALUE1 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE  := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Employer ID No.';
		...
		IF VS_VALUE2 IS NULL OR VS_VALUE2 = '' THEN
			VL_OUTPUT_SQLCODE := '503';
			VS_ERROR_CODE  := '503';
			VS_ERROR_DESC := '(E&E) Missing Mandatory Field Employer Name.';
		...
		BEGIN           
			...
			VL_OUTPUT_SQLCODE := '504';	
			VS_ERROR_CODE  := '504';
			VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Employer ID No.';
		...
		IF LENGTH(VS_VALUE3) > 0 THEN
            ...
            BEGIN                            
				...
				VL_OUTPUT_SQLCODE := '504';	
				VS_ERROR_CODE  := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Employer Start Date.';
		...
		IF LENGTH(VS_VALUE4) > 0 THEN
			...
			BEGIN                        
				...
				VL_OUTPUT_SQLCODE := '504';	
				VS_ERROR_CODE  := '504';
				VS_ERROR_DESC := '(E&E) Batch Line Has Invalid Data For Employer End Date.';
		...
		IF EXISTS(SELECT 1 from caresclientemployer WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
			...
			IF EXISTS(SELECT 1 from caresclientemployer WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id))
				= SUBSTRING('0000000000',1,10 - LENGTH(VS_CIS_CLIENT_ID::varchar):: integer) || (VS_CIS_CLIENT_ID) AND employeridno = VS_VALUE1::INTEGER AND activeflag = 0)   THEN                                        
					VL_OUTPUT_SQLCODE := '504';
					VS_ERROR_CODE  := '504';
					VS_MESSAGE := '(E&E) DELETED RECORD EXISTS IN caresclientemployer FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'') ;
					VS_ERROR_DESC := '(E&E) DELETED RECORD EXISTS IN caresclientemployer FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'') ;
				...
				BEGIN                               
					UPDATE caresclientemployer
						...
						employerenddate = (CASE WHEN VS_VALUE4 IS NULL THEN NULL
												...
												ELSE DATE(VS_VALUE4)
											END),
						employerdeleteflag = (CASE WHEN VS_VALUE5 = 'Y' THEN 0 ELSE 1 END)::integer,
						updatedby = VS_BATCH_USER,
						updatedon = CURRENT_TIMESTAMP,
						statusflag = 1
					WHERE SUBSTRING('0000000000',1,10 - LENGTH(LTRIM(RTRIM(old_id)))) || LTRIM(RTRIM(old_id)) 
					...
					VL_OUTPUT_SQLCODE := '504';
					VS_ERROR_CODE  := '504';
					VS_MESSAGE := '(E&E) UPDATE OF caresclientemployer FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
					VS_ERROR_DESC := '(E&E) UPDATE OF caresclientemployer FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
			...
			BEGIN          
				...
				SELECT
					...
					(CASE WHEN VS_VALUE4 IS NULL THEN NULL
						...
						ELSE VS_VALUE4::DATE
					END),
					(CASE WHEN VS_VALUE5  = 'Y' THEN 0 ELSE 1 END)::integer,
					VS_BATCH_USER,
					CURRENT_TIMESTAMP,
					VS_BATCH_USER,
					CURRENT_TIMESTAMP,
				...
				VL_OUTPUT_SQLCODE := '504';
				VS_ERROR_CODE  := '504';
				VS_MESSAGE := '(E&E) INSERT INTO caresclientemployer FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM ;
				VS_ERROR_DESC := '(E&E) INSERT INTO caresclientemployer FAILED FOR old_id-cisclientid: ' || coalesce(VS_CIS_CLIENT_ID,'') || ' AND employeridno: ' || coalesce(VS_VALUE1,'') || ' - ' || SQLERRM  ;
