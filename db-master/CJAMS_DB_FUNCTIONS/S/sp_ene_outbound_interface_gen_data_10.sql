CREATE OR REPLACE FUNCTION cjams.sp_ene_outbound_interface_gen_data_10(		vl_client_id integer, 
																			vl_other_id bigint, 
...
-- Description: To generate E&E Inbound data for Record Type 10
...
DECLARE VS_RECORD_TYPE VARCHAR(2);
	...
	ENE_OUT_AKA_COL1 VARCHAR(20);
	ENE_OUT_AKA_COL2 VARCHAR(20);
	ENE_OUT_AKA_COL3 VARCHAR(10);
	ENE_OUT_AKA_COL4 VARCHAR(5);
...
DECLARE CURSOR_AKA CURSOR FOR
	...
	FROM person
		LEFT OUTER JOIN alias on alias.personid = person.personid  
...
BEGIN
	...
	IF VS_RECORD_TYPE = '10' THEN
		...
		WHILE VL_OUTPUT_SQLCODE = '00000'  LOOP
			FETCH CURSOR_AKA INTO ENE_OUT_AKA_COL1, ENE_OUT_AKA_COL2, ENE_OUT_AKA_COL3, ENE_OUT_AKA_COL4;
