DROP FUNCTION IF EXISTS cjams.searchpriordsdsaction_cps(uuid, varchar, varchar, varchar);

CREATE OR REPLACE FUNCTION cjams.searchpriordsdsaction_cps(v_personid uuid, v_userid character varying) RETURNS TABLE(
...
WHERE
    ...
    and datav.datype = 'Child Protective Services'
order by
    datav.datype,
