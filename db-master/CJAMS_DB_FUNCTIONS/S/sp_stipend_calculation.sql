-- FUNCTION: cjams.sp_stipend_calculation(bigint, bigint, date, date, date, date)

 DROP FUNCTION if exists cjams.sp_stipend_calculation(bigint, bigint, date, date, date, date);

CREATE OR REPLACE FUNCTION cjams.sp_stipend_calculation(
	al_placement_id bigint,
	al_placement_structure_id bigint,
	ad_placement_start_dt date,
	ad_placement_end_dt date,
	ad_payment_start_dt date,
	ad_payment_end_dt date,
	OUT al_doc_level_id integer,
	OUT adc_stipend_amount_no numeric,
	OUT ad_service_start_dt date,
	OUT ad_service_end_dt date,
	OUT al_unit_no integer,
	OUT as_unit_type character varying,
