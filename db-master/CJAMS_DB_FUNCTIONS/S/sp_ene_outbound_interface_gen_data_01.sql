Drop function if exists cjams.sp_ene_outbound_interface_gen_data_01(integer, bigint, character varying, integer, timestamp without time zone);

CREATE OR REPLACE FUNCTION cjams.sp_ene_outbound_interface_gen_data_01(vl_client_id integer, vl_other_id bigint, vs_transaction_type_cd character varying, vl_transaction_sequence integer, vd_transaction_ts timestamp without time zone, OUT vs_message character varying, OUT vl_output_sqlcode character varying)
 RETURNS record
 LANGUAGE plpgsql
AS $function$
------------------------------------------------------------------------
...
-- Description: To generate E&E Inbound data for Record Type 1
...
-- 04/28/2022 Vineet Tirodkar - Modifications for Worker Phone Number fix (CIDM-4512)
-- 04/02/2024 Vineet Tirodkar - Modifications for Worker Phone Number - replace all non-numeric characters (CIDM-8648)
-- 05/24/2024 - Agathya - Handling the max lenght issue for the alienregistrationtext (CIDM-8906)
...
DECLARE VS_RECORD_TYPE VARCHAR(2);
	...
	-- CLIENT VARIABLES
	VL_STAFF_ID VARCHAR;
	VL_TRANSACTION_DATE INTEGER;   				-- ENE_OUT_COL1
	VS_PLACEMENT_STRUCTURE_ID CHAR(1); 			-- ENE_OUT_COL2
	VS_PRIMARY_COUNTY_CD CHAR(2);   			-- ENE_OUT_COL3
	VS_WORKER_NAME VARCHAR(50);     			-- ENE_OUT_COL4
	VS_WORKER_PHONE VARCHAR(32);        		-- ENE_OUT_COL5
	VS_CIS_CLIENT_ID VARCHAR(10);      			-- ENE_OUT_COL6
	VS_CLIENT_SURNAME VARCHAR(20);  			-- ENE_OUT_COL7
	VS_CLIENT_GIVENNAME VARCHAR(20); 			-- ENE_OUT_COL8
	VS_CLIENT_MIDDLENAME VARCHAR(10); 			-- ENE_OUT_COL9
	VS_CLIENT_SUFFIX VARCHAR(5);     			-- ENE_OUT_COL10  
	VS_AKA_LAST_NM VARCHAR(20);       			-- ENE_OUT_COL11
	VL_SSN_NO VARCHAR;                 			-- ENE_OUT_COL12
	VL_DOB_DT INTEGER;                  		-- ENE_OUT_COL13
	VS_CLIENT_GENDER CHAR(1);           		-- ENE_OUT_COL14 
	VS_CLIENT_RACE VARCHAR(20);          		-- ENE_OUT_COL15 
	VL_PLACEMENT_START_DATE INTEGER;   			-- ENE_OUT_COL16
	VL_PLACEMENT_END_DATE INTEGER;     			-- ENE_OUT_COL17
	VS_PLACEMENT_NAME VARCHAR(100);     		-- ENE_OUT_COL18
	VS_LONG_TERM_CF_INDICATOR CHAR(1);    		-- ENE_OUT_COL19
	VL_LTCF_ADMISSION_DATE INTEGER;      		-- ENE_OUT_COL20
	VL_LTCF_DISCHARGE_DATE INTEGER;       		-- ENE_OUT_COL21
	VL_PROVIDER_ID INTEGER;
	VL_PLACEMENT_CASE_ID BIGINT;
	VS_CLIENT_BIRTH_HOSPITAL VARCHAR(50);  		-- ENE_OUT_COL22
	VS_CLIENT_BIRTH_CITY VARCHAR(50);      		-- ENE_OUT_COL23
	VS_CLIENT_BIRTH_STATE CHAR(2);         		-- ENE_OUT_COL24
	VS_CLIENT_MARITAL_STATUS VARCHAR(5);    	-- ENE_OUT_COL25
	VS_CLIENT_RESIDENCY_STATUS CHAR(1);   	 	-- ENE_OUT_COL26
	VS_CLIENT_DISABLED CHAR(1) DEFAULT 'N'; 	-- ENE_OUT_COL27
	VS_CLIENT_PHYSICAL_DISABILITY CHAR(2);   	-- ENE_OUT_COL28
	VS_CLIENT_MENTAL_DISABILITY CHAR(2);      	-- ENE_OUT_COL29
	VS_CLIENT_VISUAL_DISABILITY CHAR(2);       	-- ENE_OUT_COL30
	VS_CLIENT_HEARING_DISABILITY CHAR(2);     	-- ENE_OUT_COL31
	VS_CLIENT_MENTAL_RETARDATION CHAR(2);      	-- ENE_OUT_COL32
	VS_CLIENT_LEARNING_DISABILITY CHAR(2);      -- ENE_OUT_COL33
	VS_CLIENT_COGNITIVE_DISABILITY CHAR(2);  	-- ENE_OUT_COL34
	VS_CLIENT_DEV_DELAY_DISABILITY CHAR(2);   	-- ENE_OUT_COL35
	VS_CLIENT_OTHER_DISABILITY CHAR(2);       	-- ENE_OUT_COL36
	VS_CLIENT_MEDICAL_INSURANCE CHAR(1);      	-- ENE_OUT_COL37
	ENE_OUT_COL38 CHAR(1);
	ENE_OUT_COL39 INTEGER;
	ENE_OUT_COL40 INTEGER;
	ENE_OUT_COL41 INTEGER;
	ENE_OUT_COL42 DECIMAL(10,2);
	ENE_OUT_COL42_CONVERT VARCHAR(15);
	ENE_OUT_COL43 VARCHAR(50);
	VL_PRIMARY_CAREGIVER_ID INTEGER;
	ENE_OUT_COL44 CHAR(3);
	ENE_OUT_COL45 VARCHAR(9); -- INTEGER
	ENE_OUT_COL46 VARCHAR(50);
	ENE_OUT_COL47 CHAR(5);
	ENE_OUT_COL48 CHAR(3);
	ENE_OUT_COL49 CHAR(5);
	ENE_OUT_COL50 VARCHAR(50);
	ENE_OUT_COL51 CHAR(2);
	ENE_OUT_COL52 INTEGER;
	ENE_OUT_COL53 CHAR(3);
	ENE_OUT_COL54 VARCHAR(9); -- INTEGER
	ENE_OUT_COL55 VARCHAR(50);
	ENE_OUT_COL56 CHAR(5);
	ENE_OUT_COL57 CHAR(3);
	ENE_OUT_COL58 CHAR(5);
	ENE_OUT_COL59 VARCHAR(50);
	ENE_OUT_COL60 CHAR(2);
	ENE_OUT_COL61 INTEGER;
	ENE_OUT_COL62 VARCHAR(32);
	ENE_OUT_COL63 VARCHAR(100);
	ENE_OUT_COL64 CHAR(3);
	ENE_OUT_COL65 VARCHAR(9); -- INTEGER
	ENE_OUT_COL66 VARCHAR(50);
	ENE_OUT_COL67 CHAR(5);
	ENE_OUT_COL68 CHAR(3);
	ENE_OUT_COL69 CHAR(5);
	ENE_OUT_COL70 VARCHAR(50);
	ENE_OUT_COL71 CHAR(2);
	ENE_OUT_COL72 INTEGER;
	ENE_OUT_COL73 VARCHAR(10);
	VL_ADOPTIVE_FATHER_ID INTEGER;
	VL_ADOPTIVE_MOTHER_ID INTEGER;
	ENE_OUT_COL74 VARCHAR(20);
	ENE_OUT_COL75 VARCHAR(20);
	ENE_OUT_COL76 VARCHAR(10);
	ENE_OUT_COL77 CHAR(5);
	ENE_OUT_COL78 CHAR(3);
	ENE_OUT_COL79 VARCHAR(9); -- INTEGER
	ENE_OUT_COL80 VARCHAR(50);
	ENE_OUT_COL81 CHAR(5);
	ENE_OUT_COL82 CHAR(3);
	ENE_OUT_COL83 CHAR(5);
	ENE_OUT_COL84 VARCHAR(50);
	ENE_OUT_COL85 CHAR(2);
	ENE_OUT_COL86 INTEGER;
	ENE_OUT_COL87 VARCHAR(10);
	ENE_OUT_COL88 CHAR(1);
	ENE_OUT_COL89 CHAR(1);
	ENE_OUT_COL90 CHAR(5);
	ENE_OUT_COL91 CHAR(5);
	ENE_OUT_COL92 VARCHAR(20);
	ENE_OUT_COL93 VARCHAR(20);
	ENE_OUT_COL94 CHAR(1);
	ENE_OUT_COL95 CHAR(5);
	ENE_OUT_COL96 CHAR(5);
	ENE_OUT_COL97 VARCHAR;
	ENE_OUT_COL98 VARCHAR(50);
	ENE_OUT_COL99 CHAR(3);
	ENE_OUT_COL100 VARCHAR(9); -- INTEGER
	ENE_OUT_COL101 VARCHAR(50);
	ENE_OUT_COL102 CHAR(5);
	ENE_OUT_COL103 CHAR(3);
	ENE_OUT_COL104 CHAR(5);
	ENE_OUT_COL105 VARCHAR(50);
	ENE_OUT_COL106 CHAR(2);
	ENE_OUT_COL107 INTEGER;
...
BEGIN    
	...
	BEGIN
		...
		VS_MESSAGE :=  '(E&E) SELECT cisclientid FAILED FOR person -> cjamspid :  ' || VL_CLIENT_ID::varchar ;
		RETURN;
    END ;
	...
	IF 	VS_RECORD_TYPE = '01' THEN
			...
			BEGIN   
				...
				FROM
					...
					WHERE TBS.CLIENT_ID = VL_CLIENT_ID
							...
							AND TBS.DELETE_SW = 'N'
					ORDER BY TBS.SUBSIDY_START_DT DESC, TBS.GUARDIAN_SUBSIDY_ID DESC 
					) AS A 
				LIMIT 1; 
				...
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR Guardian Subsidy ' || SQLERRM ;
				RETURN ;
			END;
			...
			BEGIN
				...
				FROM
					(SELECT  
						...
						WHEN PLACEMENT_STRUCTURE_ID in ( 8, 531 ) THEN 'K'
						ELSE 'F'
						END,
						...
						(SELECT
								...
								END
						FROM TB_PROVIDER
						WHERE PROVIDER_ID = TB_PLACEMENT.PROVIDER_ID 
							AND DELETE_SW = 'N'
						),
				...
				EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR tb_placement (1) ' || SQLERRM ;
				RETURN ;
			END;
		END IF;	
			...
			BEGIN	
				...
				(	SELECT CASE WHEN PLACEMENT_STRUCTURE_ID = 501 THEN 'A'
					...
					WHERE CLIENT_ID = VL_CLIENT_ID
						...
						AND PLACEMENT_STRUCTURE_ID IS NOT NULL
						AND DELETE_SW = 'N'
					ORDER BY ENTRY_DT DESC , PLACEMENT_ID DESC
				) AS A
				LIMIT 1 ;

				EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR tb_placement (2) ' || SQLERRM  ;
				RETURN ;
			END;
		...
		BEGIN
			...
			SELECT NULLIF(regexp_replace(phonenumber::varchar, '\D','','g'), '') as phonenumber, -- CIDM-8648
				-- right( regexp_replace (phonenumber::varchar, '[- )]+','','g')::varchar, 10) as phonenumber, -- CIDM-4512
			...
			-- RAISE NOTICE 'VS_WORKER_PHONE - 1 >> %',VS_WORKER_PHONE;	
			...
			-- RAISE NOTICE 'VS_WORKER_PHONE - 2 >> %',VS_WORKER_PHONE;	
		...
		BEGIN	
			...
			EXCEPTION WHEN OTHERS THEN
			VL_OUTPUT_SQLCODE  :=  SQLSTATE;
			VS_MESSAGE := '(E&E) SELECT FAILED FOR person (1) ' || SQLERRM  ;
			RETURN;
		END;
		...
		BEGIN 	
			...
			EXCEPTION WHEN OTHERS THEN
			VL_OUTPUT_SQLCODE  :=  SQLSTATE;
			VS_MESSAGE := '(E&E) SELECT FAILED FOR personmaritalstatus ' || SQLERRM ;
			RETURN;
		END;
		...
		BEGIN	
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR person alias ' || SQLERRM ;
				RETURN;
		END;
		...
		BEGIN	
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR clientunder5yearsinfo ' || SQLERRM ;
				RETURN;
		END;
		...
		BEGIN
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT RESIDENCY STATUS FAILED FOR tb_provider_addresses ' || SQLERRM  ;
				RETURN;
		END;	
		...
		BEGIN   
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR personmedicalinfo ' || SQLERRM ;
				RETURN;
		END ;
		...
		BEGIN
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR personhealthinsurance ' || SQLERRM ;
				RETURN ;
		END ; 	
		...
		IF VS_TRANSACTION_TYPE_CD = '15' OR VS_PLACEMENT_STRUCTURE_ID ='S' THEN -- #12329
			...
			ENE_OUT_COL38 := '';
			ENE_OUT_COL39 := NULL::INTEGER;
			ENE_OUT_COL40 := NULL::INTEGER;
		ELSE
			BEGIN
				SELECT * INTO   ENE_OUT_COL38,
								ENE_OUT_COL39,
								ENE_OUT_COL40
				FROM
				...
				EXCEPTION WHEN OTHERS THEN
					VL_OUTPUT_SQLCODE  :=  SQLSTATE;
					VS_MESSAGE := '(E&E) SELECT FAILED FOR tb_client_eligibility ' || SQLERRM ;
					RETURN ;
			END;
		END IF;
		...
		ELSIF VS_TRANSACTION_TYPE_CD = '20' THEN
			VL_TRANSACTION_DATE := ENE_OUT_COL39;
		ELSIF VS_TRANSACTION_TYPE_CD = '30' THEN
			VL_TRANSACTION_DATE := ENE_OUT_COL40;
		ELSIF VS_TRANSACTION_TYPE_CD = '40' THEN
			BEGIN			
				...
				EXCEPTION WHEN OTHERS THEN
					VL_OUTPUT_SQLCODE  :=  SQLSTATE;
					VS_MESSAGE := '(E&E) SELECT payment_dt FAILED FOR TABLE payment_header ' || SQLERRM  ;
					RETURN ;
			END;
		...
		BEGIN	
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR tb_payment_detail ' || SQLERRM ;
				RETURN;
		END ;
		
		ENE_OUT_COL42_CONVERT := LTRIM(RTRIM((ENE_OUT_COL42::VARCHAR))) ;   	
		ENE_OUT_COL42_CONVERT := SUBSTRING('00000000000',1,11 - LENGTH(ENE_OUT_COL42_CONVERT)) || ENE_OUT_COL42_CONVERT ;
		BEGIN	
			SELECT *
			INTO ENE_OUT_COL43,
			...
			EXCEPTION WHEN OTHERS THEN 			
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT PRIMARY CAREGIVER FAILED FOR intakeservreqchildremoval ' ||SQLERRM  ;
				RETURN;
		END ;
		...
		BEGIN	
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT PRIMARY CAREGIVER ADDRESS FAILED FOR personaddress ' || SQLERRM  ;
				RETURN;
		END ;
		...
		BEGIN	
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT PROVIDER LOCATION ADDRESS FAILED FOR tb_provider_addresses ' || SQLERRM  ;
				RETURN;
		END ;
		...
		BEGIN	
			...
			ENE_OUT_COL63 := CASE  WHEN LENGTH(RTRIM(LS_temp_PROVIDER_NM)) > 0 THEN -- #12329
					  LS_temp_PROVIDER_NM
			ELSE
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT PROVIDER INFO FAILED FOR tb_provider ' || SQLERRM  ;
				RETURN;
		END ;
		...
		BEGIN
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E)  SELECT PAY_TO_AFFILIATE_CD FAILED FOR tb_provider ' || SQLERRM ;
				RETURN;
		END ; 	
	   ...
	   IF VS_PAY_TO_AFFILIATE_CD IN ('3366') THEN -- For LDSS
		...
		ELSIF VS_PAY_TO_AFFILIATE_CD IN ('3368') THEN
			...
			BEGIN
				...
				EXCEPTION WHEN OTHERS THEN
					VL_OUTPUT_SQLCODE  :=  SQLSTATE;
					VS_MESSAGE := '(E&E) SELECT AFFILIATE_PROVIDER_ID FAILED FOR tb_provider ' || SQLERRM  ;
					RETURN;
			END ;
		...
		BEGIN	
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT PROVIDER MAILING ADDRESS FAILED FOR tb_provider_addresses ' || SQLERRM  ;
				RETURN;
		END ;
		
		-- Coding to start from here  ENE_OUT_COL74 to  ENE_OUT_COL88
		IF VS_PLACEMENT_STRUCTURE_ID = 'S' THEN -- #12329
			 ENE_OUT_COL74 := LS_temp_PROV_LAST_NM;
			 ENE_OUT_COL75 := LS_temp_PROV_FIRST_NM ;
			 ENE_OUT_COL76 := LS_temp_PROV_MIDDLE_NM;
			 ENE_OUT_COL77 := LS_temp_PROV_SUFFIX;
			 ENE_OUT_COL78 := ENE_OUT_COL53;
			 ENE_OUT_COL79 := ENE_OUT_COL54;
			 ENE_OUT_COL80 := ENE_OUT_COL55;
			 ENE_OUT_COL81 := ENE_OUT_COL56;
			 ENE_OUT_COL82 := ENE_OUT_COL57;
			 ENE_OUT_COL83 := ENE_OUT_COL58;
			 ENE_OUT_COL84 := ENE_OUT_COL59;
			 ENE_OUT_COL85 := ENE_OUT_COL60;
			 ENE_OUT_COL86 := ENE_OUT_COL61;
			 ENE_OUT_COL87 := ENE_OUT_COL62;
			 ENE_OUT_COL88 := 'W';
		...
		ELSIF VS_PLACEMENT_STRUCTURE_ID IN ('F','K') THEN
			...
			BEGIN
				...
				EXCEPTION WHEN OTHERS THEN
					VL_OUTPUT_SQLCODE  :=  SQLSTATE;
					VS_MESSAGE := '(E&E) SELECT STAFF INFO FAILED FOR userprofile ' || SQLERRM  ;
					RETURN;
			END;
			...
			BEGIN	
				...
				EXCEPTION WHEN OTHERS THEN
					VL_OUTPUT_SQLCODE  :=  SQLSTATE;
					VS_MESSAGE := '(E&E) SELECT STAFF ADDRESS FAILED FOR userprofileaddress ' || SQLERRM  ;
					RETURN;
			END ;
		...
		ELSIF VS_PLACEMENT_STRUCTURE_ID IN ('A') THEN
			BEGIN		
				...
				EXCEPTION WHEN OTHERS THEN
					VL_OUTPUT_SQLCODE  :=  SQLSTATE;
					VS_MESSAGE := '(E&E) SELECT ADOPTIVE INFO FAILED FOR adoptioncase ' || SQLERRM  ;
					RETURN;
			END ;
			...
			IF  VL_ADOPTIVE_FATHER_ID > 0 THEN
				...
				BEGIN			
					...
					EXCEPTION WHEN OTHERS THEN
						VL_OUTPUT_SQLCODE  :=  SQLSTATE;
						VS_MESSAGE := '(E&E) SELECT INFO FAILED FOR provapprovalperson (1) ' || SQLERRM  ;
						RETURN;
				END ;
			...
			ELSE
				BEGIN
					...
					EXCEPTION WHEN OTHERS THEN
						VL_OUTPUT_SQLCODE  :=  SQLSTATE;
						VS_MESSAGE := '(E&E) SELECT INFO FAILED FOR provapprovalperson (2) ' || SQLERRM  ;
						RETURN;
				END ;
			END IF;
		...
		BEGIN	
			-- ENE_OUT_COL89 to  ENE_OUT_COL93
...
-- Start - Changed by Agathya. Handling the max lenght issue. Setting it to null if length is more than 20.
--					alienregistrationtext	
					case when length(alienregistrationtext) > 20 then null::character varying else 	alienregistrationtext end
-- End					
			INTO 	ENE_OUT_COL89,
					ENE_OUT_COL90,
					ENE_OUT_COL91,
			...
			EXCEPTION WHEN OTHERS THEN
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT CLIENT INFO FAILED FOR person (2) ' || SQLERRM  ;
				RETURN;
		END ;
		
		BEGIN	
			-- ENE_OUT_COL94 to  ENE_OUT_COL107
			SELECT *
			INTO ENE_OUT_COL94,
				 ENE_OUT_COL95,
				 ENE_OUT_COL96,
			...
			EXCEPTION WHEN OTHERS THEN 
				VL_OUTPUT_SQLCODE  :=  SQLSTATE;
				VS_MESSAGE := '(E&E) SELECT FAILED FOR personeducation ' || SQLERRM  ;
				RETURN;
		END ;
		
		--- #17248 - 04.10.08 CHECK PHONE NOS FOR SPACES
		IF VS_WORKER_PHONE = '' OR VS_WORKER_PHONE IS NULL THEN
			VS_WORKER_PHONE := '0000000000';
		END IF;
		
		IF ENE_OUT_COL62 = '' OR ENE_OUT_COL62 IS NULL THEN
			ENE_OUT_COL62 := '0000000000';
		END IF;
		
		IF ENE_OUT_COL73 = '' OR ENE_OUT_COL73 IS NULL THEN
			ENE_OUT_COL73 := '0000000000';
		END IF;
		
		IF ENE_OUT_COL87 = '' OR ENE_OUT_COL87 IS NULL THEN
			ENE_OUT_COL87 := '0000000000';
		END IF;
		...
		BEGIN		
			...
			SELECT
				...
				ENE_OUT_COL38,
				COALESCE(CAST(ENE_OUT_COL39 AS VARCHAR),'00000000'),
				COALESCE(CAST(ENE_OUT_COL40 AS VARCHAR),'00000000'),
						COALESCE(CAST(ENE_OUT_COL41 AS VARCHAR),'00000000'),
						CASE WHEN (ENE_OUT_COL42_CONVERT = '' OR LENGTH(ENE_OUT_COL42_CONVERT) <= 0) THEN '00000000.00'
						   --  WHEN LENGTH(ENE_OUT_COL42_CONVERT) <= 0 THEN '00000000.00'
							 ELSE COALESCE(CAST(ENE_OUT_COL42_CONVERT AS VARCHAR),'00000000.00')
						END,
						ENE_OUT_COL43,
						ENE_OUT_COL44,
						ENE_OUT_COL45,
						...
						ENE_OUT_COL50,
						ENE_OUT_COL51,
						CASE WHEN (ENE_OUT_COL52 = 0 OR ENE_OUT_COL52 IS NULL) THEN '000000000'
						--     WHEN ENE_OUT_COL52 IS NULL THEN '000000000'
							 ELSE SUBSTRING('000000000',1,9 - LENGTH(LTRIM(RTRIM(CAST(ENE_OUT_COL52 AS VARCHAR))))) || LTRIM(RTRIM(CAST(ENE_OUT_COL52 AS VARCHAR)))
						END,
						ENE_OUT_COL53,
						ENE_OUT_COL54,
						ENE_OUT_COL55,
						...
						ENE_OUT_COL59,
						ENE_OUT_COL60,
						CASE WHEN (ENE_OUT_COL61 = 0 OR ENE_OUT_COL61 IS NULL) THEN '000000000'
							 --WHEN ENE_OUT_COL61 IS NULL THEN '000000000'
							 ELSE SUBSTRING('000000000',1,9 - LENGTH(LTRIM(RTRIM(CAST(ENE_OUT_COL61 AS VARCHAR))))) || LTRIM(RTRIM(CAST(ENE_OUT_COL61 AS VARCHAR)))
						END,
					   -- ENE_OUT_COL62,
						right ( regexp_replace(ENE_OUT_COL62::varchar, '[- ]+','', 'g')::varchar, 10),
						substring(ENE_OUT_COL63,1,50), 
						ENE_OUT_COL64,
						ENE_OUT_COL65,
						ENE_OUT_COL66,
						ENE_OUT_COL67,
						...
						ENE_OUT_COL70,
						ENE_OUT_COL71,
						CASE WHEN (ENE_OUT_COL72 = 0 OR ENE_OUT_COL72 IS NULL) THEN '000000000'
							 --WHEN ENE_OUT_COL72 IS NULL THEN '000000000'
							 ELSE SUBSTRING('000000000',1,9 - LENGTH(LTRIM(RTRIM(CAST(ENE_OUT_COL72 AS VARCHAR))))) || LTRIM(RTRIM(CAST(ENE_OUT_COL72 AS VARCHAR)))
						END,
						ENE_OUT_COL73,
						ENE_OUT_COL74,
						ENE_OUT_COL75,
						...
						ENE_OUT_COL84,
						ENE_OUT_COL85,
						CASE WHEN (ENE_OUT_COL86 = 0 OR ENE_OUT_COL86 IS NULL) THEN '000000000'
							 --WHEN ENE_OUT_COL86 IS NULL THEN '000000000'
							 ELSE SUBSTRING('000000000',1,9 - LENGTH(LTRIM(RTRIM(CAST(ENE_OUT_COL86 AS VARCHAR))))) || LTRIM(RTRIM(CAST(ENE_OUT_COL86 AS VARCHAR)))
						END,
						ENE_OUT_COL87,
						ENE_OUT_COL88,
						ENE_OUT_COL89,
						...
						ENE_OUT_COL105,
						ENE_OUT_COL106,
						CASE WHEN (ENE_OUT_COL107 = 0 OR ENE_OUT_COL107 IS NULL) THEN '000000000'
							 --WHEN ENE_OUT_COL107 IS NULL THEN '000000000'
							 ELSE SUBSTRING('000000000',1,9 - LENGTH(LTRIM(RTRIM(CAST(ENE_OUT_COL107 AS VARCHAR))))) || LTRIM(RTRIM(CAST(ENE_OUT_COL107 AS VARCHAR)))
						END
			   ;
