--drop function f_prim_worker_id(bigint,character varying);

CREATE OR REPLACE FUNCTION cjams.f_prim_worker_id(al_entity_key_id bigint, ai_entity_cd character varying)
 RETURNS uuid
 LANGUAGE plpgsql
AS $function$
