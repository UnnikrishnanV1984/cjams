-- CDM-33876 - Vacancy Count Incorrect
/*
-- Issue Description: 
...
-- Root cause: Provider Vacancy Data issue. 
...
-- Program ID: 50002302 - Group Home Small /Reservoir StreetGroup Home Small /Reservoir Street
-- Site ID: 5077021	(MAGIC Reservoir St	RCC Facility)
-- Contracted Beds: 7
-- Vacancy: 0

-- To fix the provider vacancy based on the current active placements (CDM-33876) 
-- Before
...
where program_id = 50002302
	and delete_sw = 'N' ;
	
-- Update
update prov.tb_contract_program cp
set update_user_id = 'CDM-33876',
	update_ts = now(),
