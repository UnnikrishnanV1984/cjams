-- CDM-14484 - Rosalind Bynum
/*
-- Issue Description: 
	User request to update the Finding as 'Unsubstantiated' and expunge the CPS-IR CW2234568 (Converted Indicated)
...
where referral_id  = 'CW2234568' ;

update tb_conv_inv_finding 
	set investigation_finding_cd = 'Unsubstantiated'
where referral_id  = 'CW2234568' ;

-- CPS-IR - CW2234568 - 12e8fad1-b51b-4bc9-9fb6-22b8970fb8a1 - Converted Indicated
-- with NO Maltreatment/Allegation & Findings (migrated data).
select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2234568'::character varying,
		null::date
	) ;
