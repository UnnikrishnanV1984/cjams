...
/*
Issue: CJAMS-65752 Overdue Response Timer
...
Data/Code fix ticket#: CJAMS-65752
...
update cjams.cpsresponsetimeractions
	set activeflag = 0, 
		updatedby = 'CJAMS-65752',
		updatedon = now()
where intakeserviceid  = 'a596bb81-5d72-469d-bd36-19deeccd1cca'
	and activeflag = 1;