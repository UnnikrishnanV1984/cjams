-- CIDM-10300 - Remove the child transection Amount
/*
-- Issue Description: We need data fix to remove the Child Transaction Amount as NaN.
Client ID: 3959983
*/

--client_account_id: 14949
-- update delete switch = 'Y'

update cjams.tb_account_transaction 	
	set delete_sw  = 'Y',
		update_user_id = 'CIDM-10300',
		update_ts = now()
where transaction_id = 1531769	and delete_sw = 'N' ;
...
set obligated_for_anc = 
		...
		where spa.delete_sw  = 'N'
			and spa.authorization_id 
				in (	select tr.authorization_id 
						...
						where tr.client_account_id = 14949
							and tr.delete_sw = 'N'
	...
	update_ts = now(),
	update_user_id = 'CIDM-10300'
where ta.client_account_id = 14949
and ta.delete_sw = 'N' ;
