/*
 * CJAMS-59243 - Finding Modification Request
 * Customer Email ID:andrea.clark@maryland.gov
 * Customer Name:Andrea Clark
 * Focus Area:Decision
 * Root cause: Modified this indicated neglect finding to ruled out neglect
 * Description - CW2225952:Please modify this indicated finding to ruled out and expunge from the system.
...
where inv_finding_id=201893 and  referral_id = 'CW2225952';

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2225952'::character varying,
		null::date
	) ;