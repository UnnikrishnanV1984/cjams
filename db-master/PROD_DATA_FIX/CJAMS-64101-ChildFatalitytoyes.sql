...
Data/Code fix ticket#: CJAMS-64101
...
set jsondata=jsonb_set(jsonb_set(jsondata,'{sdm,childfatality}','"yes"'),'{sdm,ischildfatality}','true'),
 updatedby = 'CJAMS-64101',  updatedon =now()
where intakenumber = 'I241013180614' and activeflag = 1;


update intakeservicerequestsdm
set ischildfatality = true,
   updatedby = 'CJAMS-64101',  updatedon =now()
where intakeserviceid='c6cbf2ad-422d-4a59-9709-7baf534778bd' and activeflag =1;
