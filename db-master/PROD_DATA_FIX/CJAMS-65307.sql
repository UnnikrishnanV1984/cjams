/*
Issue: CJAMS-65307 Overdue Response Timer
...
Data/Code fix ticket#: CJAMS-65307
...
update cjams.cpsresponsetimeractions
	set activeflag = 0, 
		updatedby = 'CJAMS-65307',
		updatedon = now()
where intakeserviceid  = '0b709e24-514c-4b2f-84cc-98587ff7f09b'
	and activeflag = 1;