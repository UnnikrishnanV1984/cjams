-- CDM-32816 - Expungement Request
/*
-- Issue Description: 
	User request to expunge the CPS-IR CW2248021 (Converted Indicated)
...
*/
--select actiontype, * from intakeservicerequest where servicerequestnumber ='CW2248021';

-- To expunge the Converted CPS IR case (CDM-32816)
select referral_id, maltreatment_type_cd, investigation_finding_cd 
	from tb_conv_inv_finding 
where referral_id  = 'CW2248021' ;

-- CPS IR: CW2248021 - 0597e13a-a8a0-4a6c-bc01-95eb90a27f8f
-- Converted : Physical Abuse	Indicated

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2248021'::character varying,
		null::date
	) ;