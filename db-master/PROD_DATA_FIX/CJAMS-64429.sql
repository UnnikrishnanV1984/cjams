...
set end_dt = '2021-07-01'::date ,
	end_service_reason_cd = '1824',
	update_ts = now(),
	update_user_id = 'CJAMS-64429'
where service_log_id in ( 2043822 )
	and delete_sw = 'N';	
	
update tb_service_log
set end_dt = '2025-08-04'::date ,
	end_service_reason_cd = '1824',
	update_ts = now(),
	update_user_id = 'CJAMS-64429'
where service_log_id in ( 2037317 )
	and delete_sw = 'N';