...
where assessmentid in (	select assessmentid
							...
							where intakeservicerequestactorid 
								in ( select intakeservicerequestactorid
										from intakeservicerequestactor
									 where servicecaseid = 'f867dde6-20fd-4d23-a7c6-93800a995ccb'
								    )
						 )
and submissiondata::text like '%3a49b901-c71a-418d-88e2-a1e656207cda%' ;
...
set activeflag = 0,
	...
	updatedon = now()
where personid = 'f7742cbd-283b-49d6-beae-bfb0779a11c1'
	and personprogramid = 'b6648c0c-150a-4fe8-9ea4-6c8dcc3e6f25' 
	and activeflag = 1 ;
	
update personprogramarea
set personid = '6bfdb77d-5320-477c-8b14-85d81eeee331',
	updatedby = 'CDM-23053',
	updatedon = now()
where personid = 'f7742cbd-283b-49d6-beae-bfb0779a11c1'
	and personprogramid = '2e5236f5-d9b2-46f4-88e2-1a6d177f32e1'	
	and activeflag = 1 ;	
