...
--monique.boyd1@maryland.gov

delete from cjams.userresource where roleid=135 and userid=7343 and permissiongroupid='0388441d-afe8-4aff-9553-a192e6fca30f' and activeflag=1;
...
VALUES(gen_random_uuid(), 7343, '0388441d-afe8-4aff-9553-a192e6fca30f', 135, NULL, 1, 'CDM-34461', now(), 'CDM-34461', now(), true, true, true, NULL);
