-- CDM-32330 - Expungement Request
/*
-- Issue Description: 
	User request to expunge the CPS-IR CW2270818 (Converted Indicated)
...
*/
--select actiontype, * from intakeservicerequest where servicerequestnumber ='CW2270818';

-- To expunge the Converted CPS IR case (CDM-32330)
select referral_id, maltreatment_type_cd, investigation_finding_cd 
	from tb_conv_inv_finding 
where referral_id  = 'CW2270818' ;

-- CPS IR: CW2270818 - 0597e13a-a8a0-4a6c-bc01-95eb90a27f8f
