...
/*
-- Issue Description: 
	Child Receipt Error Correction After Payment Stamping
   
--Client ID: 2071324 
---Transaction ID# 1699496

-- Category/ Module: Child Accounts (Finance Management) 
-- Root cause:Requested for a datafix to remove  Transaction(ID# 1699496) and recalculated the child account account
-- Fix Provided: Datafix has been promoted to re-calcualte update the Child Account balance and remove the transaction.
-- Is code fix required : Y (CIDM-11506)
...
set delete_sw ='Y',
update_ts = now(),
update_user_id = 'CJAMS-68417'
where transaction_id = 1699496 and delete_sw ='N';

update routing 
set activeflag =0,
updatedby ='CJAMS-68417',
updatedon =now()
where routingid ='4d57cc8a-480c-4fe9-82f3-2098c6c9db99' and activeflag =1;
...
set obligated_for_anc = 
		...
		where spa.delete_sw  = 'N'
			and spa.authorization_id 
				in (	select tr.authorization_id 
						...
						where tr.client_account_id = 1043680
							and tr.delete_sw = 'N'
	...
	update_ts = now(),
	update_user_id = 'CJAMS-68417'
where ta.client_account_id = 1043680
and ta.delete_sw = 'N' ;
