-- CDM-31828 - Expungement Request
/*
-- Issue Description: 
	User request to expunge the CPS-IR CW2385239 (Converted Indicated)
...
*/
--select actiontype, * from intakeservicerequest where servicerequestnumber ='CW2385239';

-- To expunge the Converted CPS IR case (CDM-31828)
select referral_id, maltreatment_type_cd, investigation_finding_cd 
	from tb_conv_inv_finding 
where referral_id  = 'CW2385239' ;

-- CPS IR: CW2385239 - 0597e13a-a8a0-4a6c-bc01-95eb90a27f8f
-- Converted : Physical Abuse	Indicated

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2385239'::character varying,
		null::date
	) ;