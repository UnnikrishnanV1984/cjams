-- CDM-19266 - Obligation Error
/*
-- Issue Description: 
	The youth in question, Alonna Alston, has a total of $$854.00 showing as a negative obligation.
   
-- Client ID: 1749802 (ALONNA ALSTON) - 2c63ccb5-902a-4ee0-b9d7-cdba4d49f115
-- Conserved Account ID: 15215 (#4943114132)
-- Obligated For Ancillary:  -854.00
...
set obligated_for_anc = 
		...
		where spa.delete_sw  = 'N'
			and spa.authorization_id 
				in (	select tr.authorization_id 
						...
						where tr.client_account_id = 15215
							and tr.delete_sw = 'N'
	...
	update_ts = now(),
	update_user_id = 'CDM-19266'
where ta.client_account_id = 15215
and ta.delete_sw = 'N' ;
