/*
Issue Description:CJAMS-62611 Case Plan not auto populating updated permanency plan
...
set snapshotdata = '[
  {
    ...
    "headersection": {
      "dob": "2010-09-08T00:00:00",
      "cisid": "442044013",
      "mdm_id": "MDT-124981844",
      "enddate": "2025-10-01T04:00:00",
      "clientid": 3130149,
      "childname": "ISABELLA GEARHEART",
      "startdate": "2025-04-04T04:00:00"
    },
    "incomedetails": [
      {
        "amount": 0,
    ...
    updatedon = now(),
    updatedby = 'CJAMS-62611'
WHERE 
    objectid = '344b42b3-1784-4e12-8ede-f89f17668514' 
    AND id = '3757d114-9250-4f18-895a-340f02a6ecd9' 
    AND activeflag = 1;