...
--Updating intakedastaging status to complete
update intakedastaging 
set 
	jsondata = jsonb_set(jsondata, '{DAType, DATypeDetail, 0, supStatus}', '"Approved"', false), 
	status = 'Complete', updatedby = 'CDM-40702', updatedon = now()
where id = 10250731 and activeflag = 1;