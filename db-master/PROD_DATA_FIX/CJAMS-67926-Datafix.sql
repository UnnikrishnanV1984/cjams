...
set exitdate = null ,updatedby = 'CJAMS-67926', updatedon = now()
where intakeservreqchildremovalid = 'fdbb1e4b-5311-4ae1-94dd-aa8bdac74f2d' and exitdate is not null and activeflag =1;
...
where eligibility_id  = 170031 and delete_sw = 'N';
...
update personprogramarea
set enddate = null, updatedby = 'CJAMS-67926', updatedon = now()
where personprogramid = '555f5bba-ada4-44fb-9abd-36849f127ab9' and activeflag = 1 ;
