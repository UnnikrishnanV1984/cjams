...
update placement
set exittypekey= 'CIPS',exitreasontypekey = null,updatedby = 'CJAMS-59814', updatedon = now()
where placementid = 'f660dcbb-d41f-4e08-a0a6-80ff6fe9c7e9' and activeflag=1;



update placementrevision
set exittypekey= 'CIPS',exitreasontypkey = null,updatedby = 'CJAMS-59814', updatedon = now()
where placementrevisionid = 'ec6d728b-b3fa-4ff2-bcc6-1d84d1f77dd0' and activeflag=1;
