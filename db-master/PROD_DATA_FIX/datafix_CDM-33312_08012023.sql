-- CDM-33312 - Error on Document Tab
/*
-- Issue Description: 
...
2) then run datafix_CDM-33312_08012023.sql

*/


select al_sqlcode, as_mess from cjams.sp_cw_documents_data_fix('CDM-33312'::character varying) ;
