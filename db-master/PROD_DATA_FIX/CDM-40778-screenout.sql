...
SET status = 'Closed',
updatedby = 'CDM-40778', updatedon = now(), 
jsondata = jsonb_set(jsondata, '{DAType}',
jsonb_set(jsondata->'DAType', '{DATypeDetail}',
jsonb_set(jsondata->'DAType'->'DATypeDetail', '{0}',
jsonb_set(jsondata->'DAType'->'DATypeDetail'->0, '{supDisposition}', '"ScreenOUT"'))))
WHERE intakenumber = 'I241012860615' AND activeflag=1;

-- Change the status to Approved
update routing set routingstatustypeid = 16, updatedby = 'CDM-40778',
updatedon = now() where objectid='I241012860615'and activeflag=1;
...
values ('INTR', '2917733d-a46f-429c-a438-f178ce4db044', '63fb46b7-bd92-407f-914a-2ffdc3c2d81f', 'CWIW', 'CWSP', 'I241012860615' , 8, 1, 'CDM-40778',now(),'CDM-40778', now());
