-- CDM-28092 - Incorrect Amounts for COC and Other Ancillary
/*
-- Issue Description: 
   User Request to update the SSI & Ancillary amounts for Jan 2023 as below
   
-- Client ID: 4297624 (ANGELA MELISSA HILL) - 21c20bb8-df6c-4b1b-91bb-78527697fcd4
-- Conserved Account ID: 1018547 - C564619 - $1682.00 (Available $1513.80 , Obligated for COC $168.20)
...
-- Update the SSI & Ancillary amounts for Jan 2023
-- 1170314	Cr	672.80	Receipts	Other (Ancillary Payments) - New Amount $731.20
-- 1170313	Cr	168.20	Receipts	SSI                        - New Amount $182.80 
...
where transaction_id = 1170314
	and delete_sw  = 'N' ;

update cjams.tb_account_transaction 	
	set transaction_amount_no = 731.20,
		update_user_id = 'CDM-28092',
		update_ts = now()
where transaction_id = 1170314
	and delete_sw  = 'N' ;
...
select transaction_id, transaction_amount_no, benefit_start_dt, benefit_end_dt, notes_tx,
	update_ts, update_user_id, delete_sw 
from cjams.tb_account_transaction 
where transaction_id = 1170313
	and delete_sw  = 'N' ;

update cjams.tb_account_transaction 	
	set transaction_amount_no = 182.80,
		update_user_id = 'CDM-28092',
		update_ts = now()
where transaction_id = 1170313
	and delete_sw  = 'N' ;
