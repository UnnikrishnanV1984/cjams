...
-- *****  Dependency ******
/*
Please deploy the below Stored procedures prior to this script run (datafix_CDM-24184_08052022.sql)
...
from cjams.sp_cps_responsetimer_datafix('CDM-24184'::character varying) a ;