...
Data/Code fix ticket#: CDM-42226
...
--expunging case
select vl_sqlcode, vs_err_message from cjams.expungcaserequest('IR'::character varying, 'CW2293479'::character varying, null::date);