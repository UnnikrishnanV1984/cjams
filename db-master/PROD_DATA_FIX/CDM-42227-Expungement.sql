...
Data/Code fix ticket#: CDM-42227
...
--expunging case
select vl_sqlcode, vs_err_message from cjams.expungcaserequest('IR'::character varying, 'CW2236649'::character varying, null::date);