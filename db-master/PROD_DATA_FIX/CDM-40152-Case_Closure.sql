...
update routing 
set routingstatustypeid = 2, activeflag = 1, updatedby = 'CDM-40152', updatedon = now()
where routingid = '185636bc-92c3-4772-8788-d27d2afabb06' and activeflag = 0;

--Updating intakeservicerequestdispositioncode to close the case
update intakeservicerequestdispositioncode
set activeflag = 1, intakeserreqstatustypeid = '642f18b0-ef6e-4d4b-9871-acc0734f3f5a', updatedby = 'CDM-40152', updatedon = now()
where intakeservicerequestdispositioncodeid = '0566139e-65b9-4a5e-817d-789688baeae0' and activeflag = 0;
