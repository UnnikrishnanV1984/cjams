/*
 * CJAMS-59161 - Child Account
 * Customer Email ID: michelle.forney@montgomerycountymd.gov
 * Focus Area: Child Account
 * Identified As: System error
 * Category/ Module: Child Account
 * Root cause: System Error
 * Fix Provided: Datafix has been promoted to update the the obligated for anc, total bal number, available bal number
 */
...
set obligated_for_anc = 
		...
		where spa.delete_sw  = 'N'
			and spa.authorization_id 
				in (	select tr.authorization_id 
						...
						where tr.client_account_id = 11863
							and tr.delete_sw = 'N'
	...
	update_ts = now(),
	update_user_id = 'CJAMS-59161'
where ta.client_account_id = 11863
and ta.delete_sw = 'N' ;--238.61
