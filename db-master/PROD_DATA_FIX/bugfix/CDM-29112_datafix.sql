-- CDM-29112 - Manually Trigger Response Timer Condition on all the Open CPS-IR / CPS-AR Cases
/*
-- Issue Description: 
...
from cjams.sp_cps_responsetimer_datafix('CDM-29112'::character varying) a ;