-- CDM-28518 - Pending A/R approval
/*
-- Issue Description: 
...
-- Provider ID: 5003507 (Gloria Thaxton) - Local Department Home
-- Receivable Detail ID: 693947 - 12/01/2021 To 12/31/2021 - $907.06
-- Write-Off request is for $907.06
...
where receivable_detail_id = 693947
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
...
set written_off_amount_no = null, -- 907.06
