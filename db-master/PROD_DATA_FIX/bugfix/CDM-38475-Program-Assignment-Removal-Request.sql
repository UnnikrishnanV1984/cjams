/* 
    Issue Description: CDM-38475 Please remove CIS # 473008955 program assignment from CJAMS Investigation # CW2252157. 
...
where referral_id  = 'CW2252157' ;

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
   (   'IR'::character varying,
       'CW2252157'::character varying,
       null::date
   ) ;
