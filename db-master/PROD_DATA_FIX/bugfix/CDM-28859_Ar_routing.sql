-- CDM-28859 - Pending A/R approval
/*
-- Issue Description: 
...
-- Provider ID: 5095146 (Rachel Lyons) - Local Department Home
-- Receivable Detail ID: 1722263, 1722265, 1722262 - 12/01/2021 To 12/31/2021 - $903.96
...
where receivable_detail_id in (1722263, 1722265, 1722262)
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
...
set written_off_amount_no = null, -- $903.96
	...
	write_off_request_date = null, -- 2023-02-07
	written_off_request_amount_no = null, -- 0
	update_ts = now(),
	update_user_id = 'CDM-28859'
where receivable_detail_id in (1722263, 1722265, 1722262)
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
