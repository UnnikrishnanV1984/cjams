-- CDM-28523 - Pending A/R approval
/*
-- Issue Description: 
...
-- Provider ID: 5092265 (Caitlin Blevins) - Local Department Home
-- Receivable Detail ID: 1725289, 1725280, 1725296 - 12/01/2021 To 12/31/2021 - $903.96, $903.96, $816.48
-- Write-Off request is for $903.96, $903.96, $816.48
...
where receivable_detail_id in (1725289, 1725280, 1725296)
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
