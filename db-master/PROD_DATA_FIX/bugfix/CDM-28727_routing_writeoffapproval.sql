-- CDM-28727 - Pending A/R approval
/*
-- Issue Description: 
...
-- Provider ID: 5078751 (Nataki Samdab) - Local Department Home
-- Receivable Detail ID: 1723596, 1723595, 1723576 - 12/01/2021 To 12/31/2021 - $914.10, $914.10, $914.10
-- Write-Off request is for $914.10, $914.10, $914.10
...
where receivable_detail_id in (1723596, 1723595, 1723576)
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
