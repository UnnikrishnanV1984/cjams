...
where 
inv_finding_id=259021 and 
referral_id='CW2283080';

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2283080'::character varying,
		null::date
);
...
SET investigation_finding_cd='Ruled Out'
where 
inv_finding_id=256210 and 
referral_id='CW2280269';

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2280269'::character varying,
		null::date
);