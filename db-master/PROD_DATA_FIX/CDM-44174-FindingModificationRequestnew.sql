...
Data/Code fix ticket#: CDM-44174
...
SET investigation_finding_cd='Ruled Out', etl_userid = 'CDM-44174' , etl_load_date = now()
where inv_finding_id=227623 and referral_id='CW2251682';

--expunging case
select vl_sqlcode, vs_err_message from 
cjams.expungcaserequest('IR'::character varying, 'CW2251682'::character varying, null::date);