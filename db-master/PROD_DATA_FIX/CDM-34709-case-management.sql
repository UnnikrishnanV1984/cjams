...
--lauren.estep1@maryland.gov
delete from cjams.userresource where roleid=135 and userid=12770 and permissiongroupid='0388441d-afe8-4aff-9553-a192e6fca30f' and activeflag=1;
...
VALUES(gen_random_uuid(), 12770, '0388441d-afe8-4aff-9553-a192e6fca30f', 135, NULL, 1, 'CDM-34709', now(), 'CDM-34709', now(), true, true, true, NULL);