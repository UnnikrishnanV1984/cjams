-- CDM-36542- Expungement Request
/*
-- Root cause: The Department does not have the closed record for this investigation.
-- Fix provided: Datafix has been updated to expunge the Service case # CW2286551.
...
where referral_id  = 'CW2286551' ;

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2286551'::character varying,
		null::date
	) ;