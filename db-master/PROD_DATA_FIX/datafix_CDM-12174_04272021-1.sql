...
-- Remove duplicate Supervisory approval record
select fromroleid, eventcode, objectid, routingstatustypeid, activeflag, updatedby, updatedon  
	from routing  
where objectid = '1760343'
	and fromroleid = 'CWCW'
    and routingid  = '2e012104-65e2-4f57-bf2c-171e82171144' ;
...
where objectid = '1765181'
	and fromroleid = 'CWCW'
    and routingid  = '9219cde6-5cf9-44f6-bbcd-63cad20a11b8' ;
