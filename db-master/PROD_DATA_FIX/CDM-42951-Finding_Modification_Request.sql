...
where 
inv_finding_id=185138 and 
referral_id='CW2209197';


select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2209197'::character varying,
		null::date
);
...
SET investigation_finding_cd='Ruled Out'
where 
inv_finding_id=185137 and 
referral_id='CW2209196';


select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2209196'::character varying,
		null::date
);