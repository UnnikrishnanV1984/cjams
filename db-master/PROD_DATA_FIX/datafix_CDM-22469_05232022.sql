-- CDM-22469- Placement Searching not working
/*
-- Issue Description: 
	Cannot complete placement because provider could not be found while doing a placement search.
	Provider ID: 5011110 (Michele Janette Sauder) - Local Department Home
...
where pa.provider_approval_id = 109616
	and pa.delete_sw = 'N'
	and (select count(*)
