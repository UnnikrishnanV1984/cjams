...
/*
 * 
 * Customer Email ID: golda.gaskin@maryland.gov
 ...
 * Fix Provided: Datafix has been promoted to remove below transections and updated the total amount.
    Client ID: 4088452 (Steffon Lyon)
    Account #: C799094
    Transaction ID #: 1594945
    Amount: $217.00
*/


/*
select * from tb_client_account tca where client_id = '4088452';account: 1047538
select credit_debit_sw,delete_sw ,comm_acct_trans_id ,* 
from tb_account_transaction where transaction_id in (1594945);

*/

update tb_account_transaction
    set update_ts =  now(),
        update_user_id = 'CJAMS-63699',
        delete_sw = 'Y'
where transaction_id = 1594945
and delete_sw = 'N';
...
set obligated_for_anc = 
        ...
        where spa.delete_sw  = 'N'
            and spa.authorization_id 
                in (    select tr.authorization_id 
                        ...
                        where tr.client_account_id = 1047538
                            and tr.delete_sw = 'N'
    ...
    update_ts = now(),
    update_user_id = 'CJAMS-63699'
where ta.client_account_id = 1047538
and ta.delete_sw = 'N' ;
...
where client_account_id = 1047538
    and delete_sw = 'N' ;
*/ 
...
-- no records on the fund allocation/or restaming  for this client '4088452' so no update on tb_fund_allocation_master table.