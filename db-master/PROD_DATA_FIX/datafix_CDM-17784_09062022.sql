-- CDM-17784 - Finding Change
/*
-- Issue Description: 
	User request to update the Finding as 'Unsubstantiated' and expunge the CPS-IR CW2047033 (Converted Indicated)
...
where referral_id  = 'CW2047033' ;

update tb_conv_inv_finding 
	set investigation_finding_cd = 'Unsubstantiated'
where referral_id  = 'CW2047033' ;

-- CPS IR: CW2047033 - 15cfb89f-156d-4e54-9f92-1e6d4835e702
-- Converted : Sexual Abuse - Indicated	
select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2047033'::character varying,
		null::date
	) ;
