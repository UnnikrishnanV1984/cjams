...
/*
-- Issue Description: 
   User Request to delete Child Account transaction #1158834 
   
-- Client ID: 1589947 (TA'MIRA THOMAS) - 1aa2a89a-46f1-4d2d-a3e5-dfc29d078fbf
-- Conserved Account ID: 1017175 - C291969 - $6200.04
-- Transaction ID: 1158834 - 8/5/2022 To 7/1/2022 - Adjustments	Bank Service Charges - Debit $463.20
-- Commigled Account ID: 286
...
-- Delete Transaction ID: 1158834 - 8/5/2022 To 7/1/2022 - Adjustments	Bank Service Charges - Debit $463.20
...
where transaction_id = 1158834
	and delete_sw  = 'N' ;

update cjams.tb_account_transaction 	
	set delete_sw = 'Y',
		update_user_id = 'CDM-30514',
		update_ts = now()
where transaction_id = 1158834
	and delete_sw  = 'N' ;
...
set obligated_for_anc = 
		...
		where spa.delete_sw  = 'N'
			and spa.authorization_id 
				in (	select tr.authorization_id 
						...
						where tr.client_account_id = 1017175
							and tr.delete_sw = 'N'
	...
	update_ts = now(),
	update_user_id = 'CDM-30514'
where ta.client_account_id = 1017175
and ta.delete_sw = 'N' ;
