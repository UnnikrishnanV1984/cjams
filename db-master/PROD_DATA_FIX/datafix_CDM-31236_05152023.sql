-- CDM-31236 - Expungement
/*
-- Issue Description: 
	User request To Expunge CPS IR Case CW2713536
...
-- Fix Provided: Datafix has been promoted to expunge the CPS-IR # CW2713536
-- Pull request# N/A 
-- Reason why no related code fix: N/A
-- Status of the code fix if already submitted and expected prod fix date: N/A
*/

-- CPS-IR - CW2713536 - feb3983e-64cc-4361-8790-27cb4de778c1

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2713536'::character varying,
		null::date
	) ;
