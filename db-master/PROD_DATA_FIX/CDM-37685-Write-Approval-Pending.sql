/*
-- CDM-37685 - Write Approval Pending
...
-- Receivable Detail ID: 1721621, 1721624
-- Write-Off request is for both $903.96
...
where receivable_detail_id = 1721621
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
...
set written_off_amount_no = null, -- 903.96
	...
	update_ts = now(),
	update_user_id = 'CDM-37685'
where receivable_detail_id = 1721624
	and delete_sw = 'N' 
	and ( select count(*) from routing 
		  where objectid = receivable_detail_id::character  varying
		  	and eventcode  = 'FNSWO'
