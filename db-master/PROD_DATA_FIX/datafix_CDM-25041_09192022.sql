-- CDM-25041 - Modified Finding
/*
-- Issue Description: 
	User request to update the Finding as 'Unsubstantiated' and expunge the CPS-IR CW2290192 (Converted Indicated)
...
where referral_id  = 'CW2290192' ;

update tb_conv_inv_finding 
	set investigation_finding_cd = 'Unsubstantiated'
where referral_id  = 'CW2290192' ;

-- CPS IR: CW2290192 - b6fea289-5be9-43f8-967b-41432afab1a7
-- Converted : Physical Abuse - Indicated	

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2290192'::character varying,
		null::date
	) ;
