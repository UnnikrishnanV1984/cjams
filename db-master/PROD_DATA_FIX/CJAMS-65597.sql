...
/*
Issue: CJAMS-65597 Overdue Response Timer
...
Data/Code fix ticket#: CJAMS-65597
...
update cjams.cpsresponsetimeractions
	set activeflag = 0, 
		updatedby = 'CJAMS-65597',
		updatedon = now()
where intakeserviceid  = '6051d06a-f339-4076-8311-fc2f7e42e598'
	and activeflag = 1;