...
update tb_conv_inv_finding set investigation_finding_cd = 'Physical Abuse' where referral_id ='CW2278083';

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2278083'::character varying,
		null::date
	);