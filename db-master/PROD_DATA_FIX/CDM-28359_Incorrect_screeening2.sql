...
update intakesnapshot set jsondata  = (select jsondata from intakedastaging where intakenumber ='I231010383234' and activeflag =1)
, updatedby ='CDM-28359', updatedon = now()
where intakenumber ='I231010388854' and activeflag =1;

update intakeservicerequest set  narrative= (select narrative from intakedastaging where intakenumber ='I231010383234' and activeflag =1)
, updatedby ='CDM-28359', updatedon = now()
 where intakeserviceid ='c8bdb67e-a0c6-4964-bdb9-a952520f9b65';
