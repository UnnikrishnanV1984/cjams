/*
 * CJAMS-59209 - Finding Modification Request
 * Customer Email ID:andrea.clark@maryland.gov
 * Customer Name:Andrea Clark
 * Focus Area:Decision
 * Root cause: Modified this indicated neglect finding to ruled out neglect
 * Description - CW2265171:Please modify this indicated finding to ruled out and expunge from the system.
...
where inv_finding_id=195417 and  referral_id = 'CW2219476';

select vl_sqlcode, vs_err_message
from cjams.expungcaserequest
	(	'IR'::character varying,
		'CW2219476'::character varying,
		null::date
	) ;