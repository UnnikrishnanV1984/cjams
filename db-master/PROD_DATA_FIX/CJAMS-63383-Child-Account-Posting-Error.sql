/*
Issue Description:The system duplicated an entry for an ancillary benefit. The child's conserved account should only reflect one credit of $947.00 for December 2024 Other (Ancillary Payments). 
Root cause: User Request, remove the duplicate Transaction ID - 1596056
...
--select * from tb_client_account tca where client_id = '2923067';
--select credit_debit_sw,delete_sw ,comm_acct_trans_id ,* 
--from tb_account_transaction where transaction_id in (1596056);

update tb_account_transaction
    set update_ts =  now(),
        update_user_id = 'CJAMS-63383',
        delete_sw = 'Y'
where transaction_id = 1596056
and delete_sw = 'N';

--select * from tb_client_account tca where client_id ='2923067' and delete_sw = 'N'; --1050243
...
set obligated_for_anc = 
        ...
        where spa.delete_sw  = 'N'
            and spa.authorization_id 
                in (    select tr.authorization_id 
                        ...
                        where tr.client_account_id = 1050243
                            and tr.delete_sw = 'N'
    ...
    update_ts = now(),
    update_user_id = 'CJAMS-63383'
where ta.client_account_id = 1050243
and ta.delete_sw = 'N' ;
...
where client_account_id = 1050243
    and delete_sw = 'N' ;
*/ 
...
/*
Note:
* the Source is "Other Ancillary Payments", no updates needed for tb_fund_allocation_master
* tb_fund_allocation_master comes into the picture for COC payment transaction or SSI, SSA and Other COC
*/