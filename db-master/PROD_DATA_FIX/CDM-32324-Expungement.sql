-- CDM-32324 - Expungement Request
/*
-- Issue Description: 
	User request to expunge the CPS-IR CW2280234 (Converted Indicated)
...
*/
--select actiontype, * from intakeservicerequest where servicerequestnumber ='CW2280234';

-- To expunge the Converted CPS IR case (CDM-32324)
select referral_id, maltreatment_type_cd, investigation_finding_cd 
	from tb_conv_inv_finding 
where referral_id  = 'CW2280234' ;

-- CPS IR: CW2280234 - 0597e13a-a8a0-4a6c-bc01-95eb90a27f8f
