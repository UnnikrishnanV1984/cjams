...
set investigation_finding_cd = 'Ruled Out', etl_userid = 'CDM-40197', etl_load_date = now()
where referral_id = 'CW2255992';

--Expunging the case
select vl_sqlcode, vs_err_message from cjams.expungcaserequest ('IR'::character varying, 'CW2255992'::character varying, null::date);