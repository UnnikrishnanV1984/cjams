-- CDM-31415 - Expungement Request
/*
-- Issue Description: 
	User request to expunge the CPS-IR CW2211733 (Converted Indicated)
...
*/
--select actiontype, * from intakeservicerequest where servicerequestnumber ='CW2211733';

-- To expunge the Converted CPS IR case (CDM-31415)
select referral_id, maltreatment_type_cd, investigation_finding_cd 
	from tb_conv_inv_finding 
where referral_id  = 'CW2211733' ;

-- CPS IR: CW2211733 - 0597e13a-a8a0-4a6c-bc01-95eb90a27f8f
