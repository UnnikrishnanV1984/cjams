-- CDM-28491 - Pending A/R approval
/*
-- Issue Description: 
...
-- Provider ID: 5095146 (Rachel Melanie Lyons) - Local Department Home
-- Receivable Detail ID: 1722265 - 12/01/2021 To 12/31/2021 - $903.96
...
where receivable_detail_id = 1722265
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
...
set written_off_amount_no = null, -- 903.96
	...
	write_off_request_date = null, -- 2023-01-30
	written_off_request_amount_no = null, -- 0
	update_ts = now(),
	update_user_id = 'CDM-28491'
where receivable_detail_id = 1722265
	and delete_sw = 'N' 
	and ( select count(*) 
			from routing 
