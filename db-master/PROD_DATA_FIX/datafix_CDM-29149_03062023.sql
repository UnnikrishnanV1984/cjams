-- CDM-29149 - Child Account -ve Obligated for Ancillary
/*
-- Issue Description: 
	Balance available to use in ancillary is wrong
   
-- Client ID: 1973161 (JOSHUA BURLEY) - 44e26e48-1193-4b26-8740-36dc676f652c
-- Conserved Account ID: 1016899 - $679.41
-- Obligated for Ancillary: -320.59
		...
		where spa.delete_sw  = 'N'
			and spa.authorization_id 
				in (	select tr.authorization_id 
						...
						where tr.client_account_id = 15517
							and tr.delete_sw = 'N'
