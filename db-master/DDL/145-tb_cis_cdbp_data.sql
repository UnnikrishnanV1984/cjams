...
-- DROP TABLE cjams.tb_cis_cdbp_data

CREATE TABLE cjams.tb_cis_cdbp_data (
	...
	client_expungement_sw bpchar(1) NULL,
	data_valid_sw bpchar(1) NULL,
	CONSTRAINT pk_cis_cdbp_dat PRIMARY KEY (cis_cdbp_data_id)
);

-- Permissions

ALTER TABLE cjams.tb_cis_cdbp_data OWNER TO welfareadmin;
GRANT ALL ON TABLE cjams.tb_cis_cdbp_data TO welfareadmin;