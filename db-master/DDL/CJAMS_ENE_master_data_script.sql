...
insert into cjams.tb_batch_sp_master
	(	batch_sp_master_id, batch_master_id, sp_nm, sp_desc_tx,  sp_call_level_cd,  comments_tx	 )
values
	(	95, 67, 'SP_ENE_INTERFACE_LOAD_INBOUND', 'SP to load E&E Inbound data in CJAMS/E&E Tables', NULL, '(multiple args)' );

insert into cjams.tb_batch_sp_master
	(	batch_sp_master_id, batch_master_id, sp_nm, sp_desc_tx,  sp_call_level_cd,  comments_tx	 )
values
	(	96, 67, 'SP_ENE_INTERFACE_PROCESS_INBOUND', 'SP to update the E&E Inbound data in CJAMS Tables', NULL, '(eneinterface,?,?,?,?)' );
...
-- E&E Outbound -- START	
-- Batch Master & SP Master Data
select * from cjams.tb_batch_master where batch_master_id = 68;
select * from cjams.tb_batch_sp_master where batch_master_id = 68;
...
values
(	68, 'ene_outbound.sh', NULL, 'E&E File Outbound Batch', 'Y', 
	'WD', '19:30:00', 20, 60, 'SEV-3', 
	'Y', NULL, NULL, 'Service Desk please call CJAMS on-call Support', 
	NULL, NULL, NULL, NULL);
...
insert into cjams.tb_batch_sp_master
	(	batch_sp_master_id, batch_master_id, sp_nm, sp_desc_tx,  sp_call_level_cd, comments_tx	 )
values
	(	97, 68, 'SP_ENE_INTERFACE_GENERATE_OUTBOUND', 'SP to generate outbound date for E&E', NULL, '(?,?,?,?)');
