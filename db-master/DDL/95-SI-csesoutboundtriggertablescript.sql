-- Table: cjams.csesoutboundtrigger

 DROP TABLE cjams.csesoutboundtrigger;

CREATE TABLE cjams.csesoutboundtrigger
(
    csesoutboundtriggerid uuid NOT NULL DEFAULT cjams.gen_random_uuid(),
    fk_id character varying(50) COLLATE pg_catalog."default",
...
ALTER TABLE cjams.csesoutboundtrigger
