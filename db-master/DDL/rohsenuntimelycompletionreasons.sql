-- cjams.rohsenuntimelyreasons definition

-- Drop table

-- DROP TABLE cjams.rohsenuntimelycompletionreasons;

CREATE TABLE cjams.rohsenuntimelycompletionreasons (
	rohsenuntimelycompletionreasonid uuid DEFAULT cjams.gen_random_uuid() NOT NULL,
	...
	CONSTRAINT pk_rohsenuntimelycompletionreasons PRIMARY KEY (rohsenuntimelycompletionreasonid)
);