export const environment = {
    ...
    apiHost:'https://stag3.cw.cjams.mdthink.maryland.gov/api', 
    formBuilderHost: 'https://stag3.cw.cjams.mdthink.maryland.gov/formbuilder',
    reports: 'https://stag.analytics.mdthink.maryland.gov/qliksense/hub/',
    fakeHttpResponse: false,
    envName: 'stg3',

    logoutDHSURL: 'https://stag.access.mdthink.maryland.gov/mdtsso/UI/Logout?realm=/dhs&goto=https://stag3.cw.cjams.mdthink.maryland.gov/',
    IdleTimeOut: 900,
    PopupTimeOut: 300,
