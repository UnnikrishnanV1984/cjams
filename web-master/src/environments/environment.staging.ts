export const environment = {
    ...
    IVEReferralCSMSCall: true,  // Temporary till CSMS goes live
    apiHost:'https://stag.cjams.mdthink.maryland.gov/api', 
    formBuilderHost: 'https://stag.cjams.mdthink.maryland.gov/formbuilder',
