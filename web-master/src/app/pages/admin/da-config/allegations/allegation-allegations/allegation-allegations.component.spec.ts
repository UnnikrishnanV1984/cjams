...
describe('AllegationAllegationsComponent', () => {
    let component: AllegationAllegationsComponent;
    let fixture: ComponentFixture<AllegationAllegationsComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(AllegationAllegationsComponent);
