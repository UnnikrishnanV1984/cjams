...
describe('AllegationsComponent', () => {
    let component: AllegationsComponent;
    let fixture: ComponentFixture<AllegationsComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(AllegationsComponent);
