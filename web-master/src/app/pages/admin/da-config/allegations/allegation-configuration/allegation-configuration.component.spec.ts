...
describe('AllegationConfigurationComponent', () => {
    let component: AllegationConfigurationComponent;
    let fixture: ComponentFixture<AllegationConfigurationComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(AllegationConfigurationComponent);
