...
describe('ProviderContractingComponent', () => {
    let component: ProviderContractingComponent;
    let fixture: ComponentFixture<ProviderContractingComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(ProviderContractingComponent);
