...
describe('PaActivitiesComponent', () => {
    let component: PaActivitiesComponent;
    let fixture: ComponentFixture<PaActivitiesComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(PaActivitiesComponent);
