...
describe('DsdsActionMappingCategoriesComponent', () => {
    let component: DsdsActionMappingCategoriesComponent;
    let fixture: ComponentFixture<DsdsActionMappingCategoriesComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(DsdsActionMappingCategoriesComponent);
