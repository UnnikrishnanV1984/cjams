...
describe('DsdsActionGoalsComponent', () => {
    let component: DsdsActionGoalsComponent;
    let fixture: ComponentFixture<DsdsActionGoalsComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(DsdsActionGoalsComponent);
