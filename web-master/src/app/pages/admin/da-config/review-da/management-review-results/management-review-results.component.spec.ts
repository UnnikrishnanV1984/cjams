...
describe('ManagementReviewResultsComponent', () => {
    let component: ManagementReviewResultsComponent;
    let fixture: ComponentFixture<ManagementReviewResultsComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(ManagementReviewResultsComponent);
