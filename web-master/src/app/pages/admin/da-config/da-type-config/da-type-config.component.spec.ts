...
describe('DaTypeConfigComponent', () => {
    let component: DaTypeConfigComponent;
    let fixture: ComponentFixture<DaTypeConfigComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(DaTypeConfigComponent);
