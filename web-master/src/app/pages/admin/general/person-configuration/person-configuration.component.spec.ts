...
describe('PersonConfigurationComponent', () => {
    let component: PersonConfigurationComponent;
    let fixture: ComponentFixture<PersonConfigurationComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(PersonConfigurationComponent);
