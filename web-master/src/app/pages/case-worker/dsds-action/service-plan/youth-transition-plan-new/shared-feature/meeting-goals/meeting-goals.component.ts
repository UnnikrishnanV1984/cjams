...
@Component({
    selector: 'meeting-goals',
    templateUrl: './meeting-goals.component.html',
    styleUrls: ['./meeting-goals.component.scss'],
    standalone: false
})
export class MeetingGoalsComponent implements OnInit {
