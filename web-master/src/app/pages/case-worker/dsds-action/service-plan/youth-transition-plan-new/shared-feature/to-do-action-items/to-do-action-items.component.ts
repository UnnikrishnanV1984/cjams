...
@Component({
    selector: 'to-do-action',
    templateUrl: './to-do-action-items.component.html',
    styleUrls: ['./to-do-action-items.component.scss'],
    standalone: false
})
export class ToDoActionItemsComponent implements OnInit {
