...
export class InvolvedPerson {
    ...
    issafe!: number;
    relation: any;
    relationshiptypekey: any;
    iscollateralcontact?: number;
    careGiverFlag!: boolean;
    is_mdm_sync?: boolean;
    gendertypekey!: string;
    age: any;
    programarea?: any;
    personmovestatus?: number;
}
...
export class Physician {
    ...
    physician_email: any;
    physician_phone: any;
    physician_speciality_desc: any;
    physician_name: any;
    is_primary_care_physician: any;
    personphycisianinfo_id!: string;
}
...
export class Hospitalization {
    ...
    durationmins: any;
    activeflag: any;
    Hospital_ERexamination: any;
    Hospital_InpatientAdmission: any;
    livingid: any;
    placementid: any;
    Hospital_DischargedDate: any;
    Hospital_Overstay: any;
    hospitalization_typedesc: any;
    Hospital_InpatientAdmissionDate: any;
    Hospital_examStartDate: any;
    uploadpath: any;
}
...
export class Medication {
    ...
    datemedicationstarted: any;
    updatedon: any;
    username: any;
    renewal: any;
    healthcaredecisionmaker: any;
    personmedicpshychotropicid!: string;
    secondaryreviewcompleted: any;
}
