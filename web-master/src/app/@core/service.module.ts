...
const SERVICES = [AuthService, CacheService, HttpService, GenericService, CommonHttpService, LocalStorageService, SessionStorageService, SeoService, AlertService, DataStoreService, CommonDropdownsService,IdleTimeoutService, GlobalPopupService];
