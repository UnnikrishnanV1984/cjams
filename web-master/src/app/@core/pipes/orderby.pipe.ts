...
export class OrderByPipe implements PipeTransform {
  ...
  static caseInsensitiveSort(a: any, b: any) {
    if (OrderByPipe.isString(a) && OrderByPipe.isString(b)) {
      let a_str:string = a as string;
      let b_str:string = b as string;
  ...
  private sortArray(value: any[], expression?: any, reverse?: boolean, isCaseInsensitive?: boolean, comparator?: Function): any[] {
    ...
    //SonarQube code complexity fix - moved it as seperate function
    const array: any[] = this.sortArryItems (value,expression,compareFn,isDeepLink);
  ...
  sortArryItems (value: any[],expression: any,compareFn: Function,isDeepLink: any){
  ...
  private transformObject(value: any | any[], expression?: any, reverse?: boolean, isCaseInsensitive?: boolean, comparator?: Function): any {
    ...
    const parsedExpression: any = OrderByPipe.parseExpression(expression);
   ...
   * @returns {any}
   */
  private multiExpressionTransform(value: any, expressions: any[], reverse: boolean | undefined, isCaseInsensitive: boolean = false, comparator?: Function): any {
